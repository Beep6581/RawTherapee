...
function CreateDmg {
    ...
    if [[ $FANCY_DMG == "ON" ]]; then
        ...
        magick ./rtdmg-bkgd.png -pointsize 90 -fill Black -gravity center -font Menlo-Bold -draw "text 5,120 \"$MESSAGE\"" -fill Red -gravity center -font Menlo-Bold -draw "text 1,124 \"$MESSAGE\"" ${PROJECT_SOURCE_DATA_DIR}/rtdmg-bkgd.png
        create-dmg \
