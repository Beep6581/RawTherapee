...
public:
    CALensInterpreter ()
    {
        ...
        //
        // When there are multiple matches for an ID, the text
        // 'or ...' is added in the first entry.
        // If there are one or two other lens manufacturers,
        // their names are explicitly given: 'or Sigma Lens',
        // or 'or Sigma or Tokina Lens'. For more manufacturers
        // use 'or Other Lens'. If another lens from the same
        // manufacturer is listed use 'or other ... Lens'.
        //
        choices = {
            ...
            {37, "Tamron AF 28-300mm f/3.5-6.3 XR Di VC LD Aspherical [IF] Macro"},
            ...
            {117, "Tamron 35-150mm f/2.8-4.0 Di VC OSD or other Tamron Lens"},
            {117, "Tamron SP 35mm f/1.4 Di USD"},
            ...
            {136, "Canon EF 300mm f/2.8L USM or Tamron Lens"},
            {136, "Tamron SP 15-30mm f/2.8 Di VC USD"},
            ...
            {143, "Sigma 24-105mm f/4 DG OS HSM | A"},
            ...
            {153, "Tamron AF 18-200mm f/3.5-6.3 XR Di II LD Aspherical [IF] Macro"},
            ...
            {173, "Canon EF 180mm Macro f/3.5L USM or Sigma or Venus Laowa Lens"},
            ...
            {173, "Sigma 150-500 f/5-6.3 APO DG OS HSM + 2x"},
            {174, "Canon EF 135mm f/2L USM or Sigma or Zeiss Lens"},
            ...
            {198, "Canon EF 50mm f/1.4 USM or Zeiss or Yongnuo Lens"},
            ...
            {250, "Canon EF 24mm f/1.4L II USM or Sigma or Tokina Lens"},
            ...
            {255, "Sigma 24-105mm f/4 DG OS HSM | A or other Sigma or Tamron Lens"},
            ...
            {491, "Tamron SP 70-200mm f/2.8 Di VC USD G2"},
            {491, "Tamron 18-400mm f/3.5-6.3 Di II VC HLD"},
            {491, "Tamron 100-400mm f/4.5-6.3 Di VC USD"},
            {491, "Tamron 70-210mm f/4 Di VC USD"},
            {491, "Tamron 70-210mm f/4 Di VC USD + 1.4x"},
            {491, "Tamron SP 24-70mm f/2.8 Di VC USD G2"},
            {492, "Canon EF 400mm f/2.8L IS II USM"},
            {493, "Canon EF 500mm f/4L IS II USM or other Canon Lens"},
            ...
            {502, "Tamron 35mm f/1.8 Di VC USD"},
            ...
            {750, "Tamron SP 85mm f/1.8 Di VC USD"},
            {750, "Tamron SP 45mm f/1.8 Di VC USD"},
