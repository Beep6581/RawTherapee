...
public:
    PALensTypeInterpreter ()
    {
        ...
        choices.insert(p_t(256 * 3 + 17, "smc PENTAX-FA SOFT 85mm F2.8"));
        choices.insert(p_t(256 * 3 + 18, "smc PENTAX-F 1.7X AF ADAPTER"));
        choices.insert(p_t(256 * 3 + 19, "smc PENTAX-F 24-50mm F4"));
        choices.insert(p_t(256 * 3 + 20, "smc PENTAX-F 35-80mm F4-5.6"));
        choices.insert(p_t(256 * 3 + 21, "smc PENTAX-F 80-200mm F4.7-5.6"));
        choices.insert(p_t(256 * 3 + 22, "smc PENTAX-F FISH-EYE 17-28mm F3.5-4.5"));
        choices.insert(p_t(256 * 3 + 23, "smc PENTAX-F 100-300mm F4.5-5.6 or Sigma Lens"));
        choices.insert(p_t(256 * 3 + 23, "Sigma AF 28-300mm F3.5-5.6 DL IF"));
        choices.insert(p_t(256 * 3 + 23, "Sigma AF 28-300mm F3.5-6.3 DG IF Macro"));
        choices.insert(p_t(256 * 3 + 23, "Tokina 80-200mm F2.8 ATX-Pro"));
        choices.insert(p_t(256 * 3 + 24, "smc PENTAX-F 35-135mm F3.5-4.5"));
        choices.insert(p_t(256 * 3 + 25, "smc PENTAX-F 35-105mm F4-5.6 or Sigma or Tokina Lens"));
        choices.insert(p_t(256 * 3 + 25, "Sigma AF 28-300mm F3.5-5.6 DL IF"));
        choices.insert(p_t(256 * 3 + 25, "Sigma 55-200mm F4-5.6 DC"));
        choices.insert(p_t(256 * 3 + 25, "Sigma AF 28-300mm F3.5-6.3 DL IF"));
        choices.insert(p_t(256 * 3 + 25, "Sigma AF 28-300mm F3.5-6.3 DG IF Macro"));
        choices.insert(p_t(256 * 3 + 25, "Tokina 80-200mm F2.8 ATX-Pro"));
        choices.insert(p_t(256 * 3 + 26, "smc PENTAX-F* 250-600mm F5.6 ED[IF]"));
        choices.insert(p_t(256 * 3 + 27, "smc PENTAX-F 28-80mm F3.5-4.5 or Tokina Lens"));
        choices.insert(p_t(256 * 3 + 27, "Tokina AT-X Pro AF 28-70mm F2.6-2.8"));
        choices.insert(p_t(256 * 3 + 28, "smc PENTAX-F 35-70mm F3.5-4.5 or Tokina Lens"));
        choices.insert(p_t(256 * 3 + 28, "Tokina 19-35mm F3.5-4.5 AF"));
        choices.insert(p_t(256 * 3 + 28, "Tokina AT-X AF 400mm F5.6"));
        choices.insert(p_t(256 * 3 + 29, "PENTAX-F 28-80mm F3.5-4.5 or Sigma or Tokina Lens"));
        choices.insert(p_t(256 * 3 + 29, "Sigma AF 18-125mm F3.5-5.6 DC"));
        choices.insert(p_t(256 * 3 + 29, "Tokina AT-X PRO 28-70mm F2.6-2.8"));
        choices.insert(p_t(256 * 3 + 30, "PENTAX-F 70-200mm F4-5.6"));
        choices.insert(p_t(256 * 3 + 31, "smc PENTAX-F 70-210mm F4-5.6 or Tokina or Takumar Lens"));
        choices.insert(p_t(256 * 3 + 31, "Tokina AF 730 75-300mm F4.5-5.6"));
        choices.insert(p_t(256 * 3 + 31, "Takumar-F 70-210mm F4-5.6"));
        choices.insert(p_t(256 * 3 + 32, "smc PENTAX-F 50mm F1.4"));
        choices.insert(p_t(256 * 3 + 33, "smc PENTAX-F 50mm F1.7"));
        choices.insert(p_t(256 * 3 + 34, "smc PENTAX-F 135mm F2.8 [IF]"));
        choices.insert(p_t(256 * 3 + 35, "smc PENTAX-F 28mm F2.8"));
        choices.insert(p_t(256 * 3 + 36, "Sigma 20mm F1.8 EX DG Aspherical RF"));
        choices.insert(p_t(256 * 3 + 38, "smc PENTAX-F* 300mm F4.5 ED[IF]"));
        choices.insert(p_t(256 * 3 + 39, "smc PENTAX-F* 600mm F4 ED[IF]"));
        choices.insert(p_t(256 * 3 + 40, "smc PENTAX-F Macro 100mm F2.8"));
        choices.insert(p_t(256 * 3 + 41, "smc PENTAX-F Macro 50mm F2.8 or Sigma Lens"));
        choices.insert(p_t(256 * 3 + 41, "Sigma 50mm F2.8 Macro"));
        choices.insert(p_t(256 * 3 + 42, "Sigma 300mm F2.8 EX DG APO IF"));
        choices.insert(p_t(256 * 3 + 44, "Sigma or Tamron Lens (3 44)"));
        choices.insert(p_t(256 * 3 + 44, "Sigma AF 10-20mm F4-5.6 EX DC"));
        choices.insert(p_t(256 * 3 + 44, "Sigma 12-24mm F4.5-5.6 EX DG"));
        choices.insert(p_t(256 * 3 + 44, "Sigma 17-70mm F2.8-4.5 DC Macro"));
        choices.insert(p_t(256 * 3 + 44, "Sigma 18-50mm F3.5-5.6 DC"));
        choices.insert(p_t(256 * 3 + 44, "Tamron 35-90mm F4 AF"));
        choices.insert(p_t(256 * 3 + 46, "Sigma or Samsung Lens (3 46)"));
        choices.insert(p_t(256 * 3 + 46, "Sigma APO 70-200mm F2.8 EX"));
        choices.insert(p_t(256 * 3 + 46, "Sigma EX APO 100-300mm F4 IF"));
        choices.insert(p_t(256 * 3 + 46, "Samsung/Schneider D-XENON 50-200mm F4-5.6 ED"));
        choices.insert(p_t(256 * 3 + 50, "smc PENTAX-FA 28-70mm F4 AL"));
        choices.insert(p_t(256 * 3 + 51, "Sigma 28mm F1.8 EX DG Aspherical Macro"));
        choices.insert(p_t(256 * 3 + 52, "smc PENTAX-FA 28-200mm F3.8-5.6 AL[IF] or Tamron Lens"));
        choices.insert(p_t(256 * 3 + 52, "Tamron AF LD 28-200mm F3.8-5.6 [IF] Aspherical (171D)"));
        choices.insert(p_t(256 * 3 + 53, "smc PENTAX-FA 28-80mm F3.5-5.6 AL"));
        choices.insert(p_t(256 * 3 + 247, "smc PENTAX-DA FISH-EYE 10-17mm F3.5-4.5 ED[IF]"));
        choices.insert(p_t(256 * 3 + 248, "smc PENTAX-DA 12-24mm F4 ED AL[IF]"));
        choices.insert(p_t(256 * 3 + 250, "smc PENTAX-DA 50-200mm F4-5.6 ED"));
        choices.insert(p_t(256 * 3 + 251, "smc PENTAX-DA 40mm F2.8 Limited"));
        choices.insert(p_t(256 * 3 + 252, "smc PENTAX-DA 18-55mm F3.5-5.6 AL"));
        choices.insert(p_t(256 * 3 + 253, "smc PENTAX-DA 14mm F2.8 ED[IF]"));
        choices.insert(p_t(256 * 3 + 254, "smc PENTAX-DA 16-45mm F4 ED AL"));
        choices.insert(p_t(256 * 3 + 255, "Sigma Lens (3 255)"));
        choices.insert(p_t(256 * 3 + 255, "Sigma 18-200mm F3.5-6.3 DC"));
        choices.insert(p_t(256 * 3 + 255, "Sigma DL-II 35-80mm F4-5.6"));
        choices.insert(p_t(256 * 3 + 255, "Sigma DL Zoom 75-300mm F4-5.6"));
        choices.insert(p_t(256 * 3 + 255, "Sigma DF EX Aspherical 28-70mm F2.8"));
        choices.insert(p_t(256 * 3 + 255, "Sigma AF Tele 400mm F5.6 Multi-coated"));
        choices.insert(p_t(256 * 3 + 255, "Sigma 24-60mm F2.8 EX DG"));
        choices.insert(p_t(256 * 3 + 255, "Sigma 70-300mm F4-5.6 Macro"));
        choices.insert(p_t(256 * 3 + 255, "Sigma 55-200mm F4-5.6 DC"));
        choices.insert(p_t(256 * 3 + 255, "Sigma 18-50mm F2.8 EX DC"));
        choices.insert(p_t(256 * 4 + 1, "smc PENTAX-FA SOFT 28mm F2.8"));
        choices.insert(p_t(256 * 4 + 2, "smc PENTAX-FA 80-320mm F4.5-5.6"));
        choices.insert(p_t(256 * 4 + 3, "smc PENTAX-FA 43mm F1.9 Limited"));
        choices.insert(p_t(256 * 4 + 6, "smc PENTAX-FA 35-80mm F4-5.6"));
        choices.insert(p_t(256 * 4 + 12, "smc PENTAX-FA 50mm F1.4"));
        choices.insert(p_t(256 * 4 + 15, "smc PENTAX-FA 28-105mm F4-5.6 [IF]"));
        choices.insert(p_t(256 * 4 + 16, "Tamron AF 80-210mm F4-5.6 (178D)"));
        choices.insert(p_t(256 * 4 + 19, "Tamron SP AF 90mm F2.8 (172E)"));
        choices.insert(p_t(256 * 4 + 20, "smc PENTAX-FA 28-80mm F3.5-5.6"));
        choices.insert(p_t(256 * 4 + 21, "Cosina AF 100-300mm F5.6-6.7"));
        choices.insert(p_t(256 * 4 + 22, "Tokina 28-80mm F3.5-5.6"));
        choices.insert(p_t(256 * 4 + 23, "smc PENTAX-FA 20-35mm F4 AL"));
        choices.insert(p_t(256 * 4 + 24, "smc PENTAX-FA 77mm F1.8 Limited"));
        choices.insert(p_t(256 * 4 + 25, "Tamron SP AF 14mm F2.8"));
        choices.insert(p_t(256 * 4 + 26, "smc PENTAX-FA Macro 100mm F3.5 or Cosina Lens"));
        choices.insert(p_t(256 * 4 + 26, "Cosina 100mm F3.5 Macro"));
        choices.insert(p_t(256 * 4 + 27, "Tamron AF 28-300mm F3.5-6.3 LD Aspherical[IF] Macro (185D/285D)"));
        choices.insert(p_t(256 * 4 + 28, "smc PENTAX-FA 35mm F2 AL"));
        choices.insert(p_t(256 * 4 + 29, "Tamron AF 28-200mm F3.8-5.6 LD Super II Macro (371D)"));
        choices.insert(p_t(256 * 4 + 34, "smc PENTAX-FA 24-90mm F3.5-4.5 AL[IF]"));
        choices.insert(p_t(256 * 4 + 35, "smc PENTAX-FA 100-300mm F4.7-5.8"));
        choices.insert(p_t(256 * 4 + 36, "Tamron AF 70-300mm F4-5.6 LD Macro 1:2"));
        choices.insert(p_t(256 * 4 + 37, "Tamron SP AF 24-135mm F3.5-5.6 AD AL (190D)"));
        choices.insert(p_t(256 * 4 + 38, "smc PENTAX-FA 28-105mm F3.2-4.5 AL[IF]"));
        choices.insert(p_t(256 * 4 + 39, "smc PENTAX-FA 31mm F1.8 AL Limited"));
        choices.insert(p_t(256 * 4 + 41, "Tamron AF 28-200mm Super Zoom F3.8-5.6 Aspherical XR [IF] Macro (A03)"));
        choices.insert(p_t(256 * 4 + 43, "smc PENTAX-FA 28-90mm F3.5-5.6"));
        choices.insert(p_t(256 * 4 + 44, "smc PENTAX-FA J 75-300mm F4.5-5.8 AL"));
        choices.insert(p_t(256 * 4 + 45, "Tamron Lens (4 45)"));
        choices.insert(p_t(256 * 4 + 45, "Tamron 28-300mm F3.5-6.3 Ultra zoom XR"));
        choices.insert(p_t(256 * 4 + 45, "Tamron AF 28-300mm F3.5-6.3 XR Di LD Aspherical [IF] Macro"));
        choices.insert(p_t(256 * 4 + 46, "smc PENTAX-FA J 28-80mm F3.5-5.6 AL"));
        choices.insert(p_t(256 * 4 + 47, "smc PENTAX-FA J 18-35mm F4-5.6 AL"));
        choices.insert(p_t(256 * 4 + 49, "Tamron SP AF 28-75mm F2.8 XR Di LD Aspherical [IF] Macro"));
        choices.insert(p_t(256 * 4 + 51, "smc PENTAX-D FA 50mm F2.8 Macro"));
        choices.insert(p_t(256 * 4 + 52, "smc PENTAX-D FA 100mm F2.8 Macro"));
        choices.insert(p_t(256 * 4 + 55, "Samsung/Schneider D-XENOGON 35mm F2"));
        choices.insert(p_t(256 * 4 + 56, "Samsung/Schneider D-XENON 100mm F2.8 Macro"));
        choices.insert(p_t(256 * 4 + 75, "Tamron SP AF 70-200mm F2.8 Di LD [IF] Macro (A001)"));
        choices.insert(p_t(256 * 4 + 214, "smc PENTAX-DA 35mm F2.4 AL"));
        choices.insert(p_t(256 * 4 + 229, "smc PENTAX-DA 18-55mm F3.5-5.6 AL II"));
        choices.insert(p_t(256 * 4 + 230, "Tamron SP AF 17-50mm F2.8 XR Di II"));
        choices.insert(p_t(256 * 4 + 231, "smc PENTAX-DA 18-250mm F3.5-6.3 ED AL [IF]"));
        choices.insert(p_t(256 * 4 + 237, "Samsung/Schneider D-XENOGON 10-17mm F3.5-4.5"));
        choices.insert(p_t(256 * 4 + 239, "Samsung/Schneider D-XENON 12-24mm F4 ED AL [IF]"));
        choices.insert(p_t(256 * 4 + 242, "smc PENTAX-DA* 16-50mm F2.8 ED AL [IF] SDM (SDM unused)"));
        choices.insert(p_t(256 * 4 + 243, "smc PENTAX-DA 70mm F2.4 Limited"));
        choices.insert(p_t(256 * 4 + 244, "smc PENTAX-DA 21mm F3.2 AL Limited"));
        choices.insert(p_t(256 * 4 + 245, "Samsung/Schneider D-XENON 50-200mm F4-5.6"));
        choices.insert(p_t(256 * 4 + 246, "Samsung/Schneider D-XENON 18-55mm F3.5-5.6"));
        choices.insert(p_t(256 * 4 + 247, "smc PENTAX-DA FISH-EYE 10-17mm F3.5-4.5 ED[IF]"));
        choices.insert(p_t(256 * 4 + 248, "smc PENTAX-DA 12-24mm F4 ED AL [IF]"));
        choices.insert(p_t(256 * 4 + 249, "Tamron XR DiII 18-200mm F3.5-6.3 (A14)"));
        choices.insert(p_t(256 * 4 + 250, "smc PENTAX-DA 50-200mm F4-5.6 ED"));
        choices.insert(p_t(256 * 4 + 251, "smc PENTAX-DA 40mm F2.8 Limited"));
        choices.insert(p_t(256 * 4 + 252, "smc PENTAX-DA 18-55mm F3.5-5.6 AL"));
        choices.insert(p_t(256 * 4 + 253, "smc PENTAX-DA 14mm F2.8 ED[IF]"));
        choices.insert(p_t(256 * 4 + 254, "smc PENTAX-DA 16-45mm F4 ED AL"));
        choices.insert(p_t(256 * 5 + 1, "smc PENTAX-FA* 24mm F2 AL[IF]"));
        choices.insert(p_t(256 * 5 + 2, "smc PENTAX-FA 28mm F2.8 AL"));
        choices.insert(p_t(256 * 5 + 3, "smc PENTAX-FA 50mm F1.7"));
        choices.insert(p_t(256 * 5 + 4, "smc PENTAX-FA 50mm F1.4"));
        choices.insert(p_t(256 * 5 + 5, "smc PENTAX-FA* 600mm F4 ED[IF]"));
        choices.insert(p_t(256 * 5 + 6, "smc PENTAX-FA* 300mm F4.5 ED[IF]"));
        choices.insert(p_t(256 * 5 + 7, "smc PENTAX-FA 135mm F2.8 [IF]"));
        choices.insert(p_t(256 * 5 + 8, "smc PENTAX-FA Macro 50mm F2.8"));
        choices.insert(p_t(256 * 5 + 9, "smc PENTAX-FA Macro 100mm F2.8"));
        choices.insert(p_t(256 * 5 + 10, "smc PENTAX-FA* 85mm F1.4 [IF]"));
        choices.insert(p_t(256 * 5 + 11, "smc PENTAX-FA* 200mm F2.8 ED[IF]"));
        choices.insert(p_t(256 * 5 + 12, "smc PENTAX-FA 28-80mm F3.5-4.7"));
        choices.insert(p_t(256 * 5 + 13, "smc PENTAX-FA 70-200mm F4-5.6"));
        choices.insert(p_t(256 * 5 + 14, "smc PENTAX-FA* 250-600mm F5.6 ED[IF]"));
        choices.insert(p_t(256 * 5 + 15, "smc PENTAX-FA 28-105mm F4-5.6"));
        choices.insert(p_t(256 * 5 + 16, "smc PENTAX-FA 100-300mm F4.5-5.6"));
        choices.insert(p_t(256 * 5 + 98, "smc PENTAX-FA 100-300mm F4.5-5.6"));
        choices.insert(p_t(256 * 6 + 1, "smc PENTAX-FA* 85mm F1.4 [IF]"));
        choices.insert(p_t(256 * 6 + 2, "smc PENTAX-FA* 200mm F2.8 ED[IF]"));
        choices.insert(p_t(256 * 6 + 3, "smc PENTAX-FA* 300mm F2.8 ED[IF]"));
        choices.insert(p_t(256 * 6 + 4, "smc PENTAX-FA* 28-70mm F2.8 AL"));
        choices.insert(p_t(256 * 6 + 5, "smc PENTAX-FA* 80-200mm F2.8 ED[IF]"));
        choices.insert(p_t(256 * 6 + 6, "smc PENTAX-FA* 28-70mm F2.8 AL"));
        choices.insert(p_t(256 * 6 + 7, "smc PENTAX-FA* 80-200mm F2.8 ED[IF]"));
        choices.insert(p_t(256 * 6 + 8, "smc PENTAX-FA 28-70mm F4AL"));
        choices.insert(p_t(256 * 6 + 9, "smc PENTAX-FA 20mm F2.8"));
        choices.insert(p_t(256 * 6 + 10, "smc PENTAX-FA* 400mm F5.6 ED[IF]"));
        choices.insert(p_t(256 * 6 + 13, "smc PENTAX-FA* 400mm F5.6 ED[IF]"));
        choices.insert(p_t(256 * 6 + 14, "smc PENTAX-FA* Macro 200mm F4 ED[IF]"));
        choices.insert(p_t(256 * 7 + 0, "smc PENTAX-DA 21mm F3.2 AL Limited"));
        choices.insert(p_t(256 * 7 + 58, "smc PENTAX-D FA Macro 100mm F2.8 WR"));
        choices.insert(p_t(256 * 7 + 75, "Tamron SP AF 70-200mm F2.8 Di LD [IF] Macro (A001)"));
        choices.insert(p_t(256 * 7 + 201, "smc Pentax-DA L 50-200mm F4-5.6 ED WR"));
        choices.insert(p_t(256 * 7 + 202, "smc PENTAX-DA L 18-55mm F3.5-5.6 AL WR"));
        choices.insert(p_t(256 * 7 + 203, "HD PENTAX-DA 55-300mm F4-5.8 ED WR"));
        choices.insert(p_t(256 * 7 + 204, "HD PENTAX-DA 15mm F4 ED AL Limited"));
        choices.insert(p_t(256 * 7 + 205, "HD PENTAX-DA 35mm F2.8 Macro Limited"));
        choices.insert(p_t(256 * 7 + 206, "HD PENTAX-DA 70mm F2.4 Limited"));
        choices.insert(p_t(256 * 7 + 207, "HD PENTAX-DA 21mm F3.2 ED AL Limited"));
        choices.insert(p_t(256 * 7 + 208, "HD PENTAX-DA 40mm F2.8 Limited"));
        choices.insert(p_t(256 * 7 + 212, "smc PENTAX-DA 50mm F1.8"));
        choices.insert(p_t(256 * 7 + 213, "smc PENTAX-DA 40mm F2.8 XS"));
        choices.insert(p_t(256 * 7 + 214, "smc PENTAX-DA 35mm F2.4 AL"));
        choices.insert(p_t(256 * 7 + 216, "smc PENTAX-DA L 55-300mm F4-5.8 ED"));
        choices.insert(p_t(256 * 7 + 217, "smc PENTAX-DA 50-200mm F4-5.6 ED WR"));
        choices.insert(p_t(256 * 7 + 218, "smc PENTAX-DA 18-55mm F3.5-5.6 AL WR"));
        choices.insert(p_t(256 * 7 + 220, "Tamron SP AF 10-24mm F3.5-4.5 Di II LD Aspherical [IF]"));
        choices.insert(p_t(256 * 7 + 221, "smc PENTAX-DA L 50-200mm F4-5.6 ED"));
        choices.insert(p_t(256 * 7 + 222, "smc PENTAX-DA L 18-55mm F3.5-5.6"));
        choices.insert(p_t(256 * 7 + 223, "Samsung/Schneider D-XENON 18-55mm F3.5-5.6 II"));
        choices.insert(p_t(256 * 7 + 224, "smc PENTAX-DA 15mm F4 ED AL Limited"));
        choices.insert(p_t(256 * 7 + 225, "Samsung/Schneider D-XENON 18-250mm F3.5-6.3"));
        choices.insert(p_t(256 * 7 + 226, "smc PENTAX-DA* 55mm F1.4 SDM (SDM unused)"));
        choices.insert(p_t(256 * 7 + 227, "smc PENTAX-DA* 60-250mm F4 [IF] SDM (SDM unused)"));
        choices.insert(p_t(256 * 7 + 228, "Samsung 16-45mm F4 ED"));
        choices.insert(p_t(256 * 7 + 229, "smc PENTAX-DA 18-55mm F3.5-5.6 AL II"));
        choices.insert(p_t(256 * 7 + 230, "Tamron AF 17-50mm F2.8 XR Di-II LD (Model A16)"));
        choices.insert(p_t(256 * 7 + 231, "smc PENTAX-DA 18-250mm F3.5-6.3 ED AL [IF]"));
        choices.insert(p_t(256 * 7 + 233, "smc PENTAX-DA 35mm F2.8 Macro Limited"));
        choices.insert(p_t(256 * 7 + 234, "smc PENTAX-DA* 300mm F4 ED [IF] SDM (SDM unused)"));
        choices.insert(p_t(256 * 7 + 235, "smc PENTAX-DA* 200mm F2.8 ED [IF] SDM (SDM unused)"));
        choices.insert(p_t(256 * 7 + 236, "smc PENTAX-DA 55-300mm F4-5.8 ED"));
        choices.insert(p_t(256 * 7 + 238, "Tamron AF 18-250mm F3.5-6.3 Di II LD Aspherical [IF] Macro"));
        choices.insert(p_t(256 * 7 + 241, "smc PENTAX-DA* 50-135mm F2.8 ED [IF] SDM (SDM unused)"));
        choices.insert(p_t(256 * 7 + 242, "smc PENTAX-DA* 16-50mm F2.8 ED AL [IF] SDM (SDM unused)"));
        choices.insert(p_t(256 * 7 + 243, "smc PENTAX-DA 70mm F2.4 Limited"));
        choices.insert(p_t(256 * 7 + 244, "smc PENTAX-DA 21mm F3.2 AL Limited"));
        choices.insert(p_t(256 * 8 + 0, "Sigma 50-150mm F2.8 II APO EX DC HSM"));
        choices.insert(p_t(256 * 8 + 3, "Sigma AF 18-125mm F3.5-5.6 DC"));
        choices.insert(p_t(256 * 8 + 4, "Sigma 50mm F1.4 EX DG HSM"));
        choices.insert(p_t(256 * 8 + 7, "Sigma 24-70mm F2.8 IF EX DG HSM"));
        choices.insert(p_t(256 * 8 + 8, "Sigma 18-250mm F3.5-6.3 DC OS HSM"));
        choices.insert(p_t(256 * 8 + 11, "Sigma 10-20mm F3.5 EX DC HSM"));
        choices.insert(p_t(256 * 8 + 12, "Sigma 70-300mm F4-5.6 DG OS"));
        choices.insert(p_t(256 * 8 + 13, "Sigma 120-400mm F4.5-5.6 APO DG OS HSM"));
        choices.insert(p_t(256 * 8 + 14, "Sigma 17-70mm F2.8-4.0 DC Macro OS HSM"));
        choices.insert(p_t(256 * 8 + 15, "Sigma 150-500mm F5-6.3 APO DG OS HSM"));
        choices.insert(p_t(256 * 8 + 16, "Sigma 70-200mm F2.8 EX DG Macro HSM II"));
        choices.insert(p_t(256 * 8 + 17, "Sigma 50-500mm F4.5-6.3 DG OS HSM"));
        choices.insert(p_t(256 * 8 + 18, "Sigma 8-16mm F4.5-5.6 DC HSM"));
        choices.insert(p_t(256 * 8 + 21, "Sigma 17-50mm F2.8 EX DC OS HSM"));
        choices.insert(p_t(256 * 8 + 22, "Sigma 85mm F1.4 EX DG HSM"));
        choices.insert(p_t(256 * 8 + 23, "Sigma 70-200mm F2.8 APO EX DG OS HSM"));
        choices.insert(p_t(256 * 8 + 25, "Sigma 17-50mm F2.8 EX DC HSM"));
        choices.insert(p_t(256 * 8 + 27, "Sigma 18-200mm F3.5-6.3 II DC HSM"));
        choices.insert(p_t(256 * 8 + 28, "Sigma 18-250mm F3.5-6.3 DC Macro HSM"));
        choices.insert(p_t(256 * 8 + 29, "Sigma 35mm F1.4 DG HSM"));
        choices.insert(p_t(256 * 8 + 30, "Sigma 17-70mm F2.8-4 DC Macro HSM Contemporary"));
        choices.insert(p_t(256 * 8 + 31, "Sigma 18-35mm F1.8 DC HSM"));
        choices.insert(p_t(256 * 8 + 32, "Sigma 30mm F1.4 DC HSM | A"));
        choices.insert(p_t(256 * 8 + 59, "HD PENTAX-D FA 150-450mm F4.5-5.6 ED DC AW"));
        choices.insert(p_t(256 * 8 + 60, "HD PENTAX-D FA* 70-200mm F2.8 ED DC AW"));
        choices.insert(p_t(256 * 8 + 198, "smc PENTAX-DA L 18-50mm F4-5.6 DC WR RE"));
        choices.insert(p_t(256 * 8 + 199, "HD PENTAX-DA 18-50mm F4-5.6 DC WR RE"));
        choices.insert(p_t(256 * 8 + 200, "HD PENTAX-DA 16-85mm F3.5-5.6 ED DC WR"));
        choices.insert(p_t(256 * 8 + 209, "HD PENTAX-DA 20-40mm F2.8-4 ED Limited DC WR"));
        choices.insert(p_t(256 * 8 + 210, "smc PENTAX-DA 18-270mm F3.5-6.3 ED SDM"));
        choices.insert(p_t(256 * 8 + 211, "HD PENTAX-DA 560mm F5.6 ED AW"));
        choices.insert(p_t(256 * 8 + 215, "smc PENTAX-DA 18-135mm F3.5-5.6 ED AL [IF] DC WR"));
        choices.insert(p_t(256 * 8 + 226, "smc PENTAX-DA* 55mm F1.4 SDM"));
        choices.insert(p_t(256 * 8 + 227, "smc PENTAX-DA* 60-250mm F4 [IF] SDM"));
        choices.insert(p_t(256 * 8 + 232, "smc PENTAX-DA 17-70mm F4 AL [IF] SDM"));
        choices.insert(p_t(256 * 8 + 234, "smc PENTAX-DA* 300mm F4 ED [IF] SDM"));
        choices.insert(p_t(256 * 8 + 235, "smc PENTAX-DA* 200mm F2.8 ED [IF] SDM"));
        choices.insert(p_t(256 * 8 + 241, "smc PENTAX-DA* 50-135mm F2.8 ED [IF] SDM"));
        choices.insert(p_t(256 * 8 + 242, "smc PENTAX-DA* 16-50mm F2.8 ED AL [IF] SDM"));
        choices.insert(p_t(256 * 8 + 255, "Sigma Lens (8 255)"));
        choices.insert(p_t(256 * 8 + 255, "Sigma 70-200mm F2.8 EX DG Macro HSM II"));
        choices.insert(p_t(256 * 8 + 255, "Sigma 150-500mm F5-6.3 DG APO [OS] HSM"));
        choices.insert(p_t(256 * 8 + 255, "Sigma 50-150mm F2.8 II APO EX DC HSM"));
        choices.insert(p_t(256 * 8 + 255, "Sigma 4.5mm F2.8 EX DC HSM Circular Fisheye"));
        choices.insert(p_t(256 * 8 + 255, "Sigma 50-200mm F4-5.6 DC OS"));
        choices.insert(p_t(256 * 8 + 255, "Sigma 24-70mm F2.8 EX DG HSM"));
        choices.insert(p_t(256 * 9 + 0, "645 Manual Lens"));
        choices.insert(p_t(256 * 10 + 0, "645 A Series Lens"));
        choices.insert(p_t(256 * 11 + 1, "smc PENTAX-FA 645 75mm F2.8"));
        choices.insert(p_t(256 * 11 + 2, "smc PENTAX-FA 645 45mm F2.8"));
        choices.insert(p_t(256 * 11 + 3, "smc PENTAX-FA* 645 300mm F4 ED [IF]"));
        choices.insert(p_t(256 * 11 + 4, "smc PENTAX-FA 645 45-85mm F4.5"));
        choices.insert(p_t(256 * 11 + 5, "smc PENTAX-FA 645 400mm F5.6 ED [IF]"));
        choices.insert(p_t(256 * 11 + 7, "smc PENTAX-FA 645 Macro 120mm F4"));
        choices.insert(p_t(256 * 11 + 8, "smc PENTAX-FA 645 80-160mm F4.5"));
        choices.insert(p_t(256 * 11 + 9, "smc PENTAX-FA 645 200mm F4 [IF]"));
        choices.insert(p_t(256 * 11 + 10, "smc PENTAX-FA 645 150mm F2.8 [IF]"));
        choices.insert(p_t(256 * 11 + 11, "smc PENTAX-FA 645 35mm F3.5 AL [IF]"));
        choices.insert(p_t(256 * 11 + 12, "smc PENTAX-FA 645 300mm F5.6 ED [IF]"));
        choices.insert(p_t(256 * 11 + 14, "smc PENTAX-FA 645 55-110mm F5.6"));
        choices.insert(p_t(256 * 11 + 16, "smc PENTAX-FA 645 33-55mm F4.5 AL"));
        choices.insert(p_t(256 * 11 + 17, "smc PENTAX-FA 645 150-300mm F5.6 ED [IF]"));
        choices.insert(p_t(256 * 13 + 18, "smc PENTAX-D FA 645 55mm F2.8 AL [IF] SDM AW"));
        choices.insert(p_t(256 * 13 + 19, "smc PENTAX-D FA 645 25mm F4 AL [IF] SDM AW"));
        choices.insert(p_t(256 * 13 + 20, "HD PENTAX-D FA 645 90mm F2.8 ED AW SR"));
        choices.insert(p_t(256 * 13 + 253, "HD PENTAX-DA 645 28-45mm F4.5 ED AW SR"));
        choices.insert(p_t(256 * 21 + 0, "Pentax Q Manual Lens"));
        choices.insert(p_t(256 * 21 + 1, "01 Standard Prime 8.5mm F1.9"));
        choices.insert(p_t(256 * 21 + 2, "02 Standard Zoom 5-15mm F2.8-4.5"));
        choices.insert(p_t(256 * 21 + 6, "06 Telephoto Zoom 15-45mm F2.8"));
        choices.insert(p_t(256 * 21 + 7, "07 Mount Shield 11.5mm F9"));
        choices.insert(p_t(256 * 21 + 8, "08 Wide Zoom 3.8-5.9mm F3.7-4"));
        choices.insert(p_t(256 * 22 + 3, "03 Fish-eye 3.2mm F5.6"));
        choices.insert(p_t(256 * 22 + 4, "04 Toy Lens Wide 6.3mm F7.1"));
        choices.insert(p_t(256 * 22 + 5, "05 Toy Lens Telephoto 18mm F8"));
    }
    virtual std::string toString (Tag* t)
    {
        double *liArray = NULL;
