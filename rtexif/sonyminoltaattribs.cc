...
public:
    SALensIDInterpreter ()
    {
        choices.insert(p_t(0, "Minolta AF 28-85mm F3.5-4.5 New"));
        choices.insert(p_t(1, "Minolta AF 80-200mm F2.8 HS-APO G"));
        choices.insert(p_t(2, "Minolta AF 28-70mm F2.8 G"));
        choices.insert(p_t(3, "Minolta AF 28-80mm F4-5.6"));
        choices.insert(p_t(4, "Minolta AF 85mm F1.4G"));
        choices.insert(p_t(5, "Minolta AF 35-70mm F3.5-4.5 [II]"));
        choices.insert(p_t(6, "Minolta AF 24-85mm F3.5-4.5 [New]"));
        choices.insert(p_t(7, "Minolta AF 100-300mm F4.5-5.6 APO [New] or 100-400mm or Sigma Lens"));
        choices.insert(p_t(7, "Minolta AF 100-400mm F4.5-6.7 APO"));
        choices.insert(p_t(7, "Sigma AF 100-300mm F4 EX DG IF"));
        choices.insert(p_t(8, "Minolta AF 70-210mm F4.5-5.6 [II]"));
        choices.insert(p_t(9, "Minolta AF 50mm F3.5 Macro"));
        choices.insert(p_t(10, "Minolta AF 28-105mm F3.5-4.5 [New]"));
        choices.insert(p_t(11, "Minolta AF 300mm F4 HS-APO G"));
        choices.insert(p_t(12, "Minolta AF 100mm F2.8 Soft Focus"));
        choices.insert(p_t(13, "Minolta AF 75-300mm F4.5-5.6 (New or II)"));
        choices.insert(p_t(14, "Minolta AF 100-400mm F4.5-6.7 APO"));
        choices.insert(p_t(15, "Minolta AF 400mm F4.5 HS-APO G"));
        choices.insert(p_t(16, "Minolta AF 17-35mm F3.5 G"));
        choices.insert(p_t(17, "Minolta AF 20-35mm F3.5-4.5"));
        choices.insert(p_t(18, "Minolta AF 28-80mm F3.5-5.6 II"));
        choices.insert(p_t(19, "Minolta AF 35mm F1.4 G"));
        choices.insert(p_t(20, "Minolta/Sony 135mm F2.8 [T4.5] STF"));
        choices.insert(p_t(22, "Minolta AF 35-80mm F4-5.6 II"));
        choices.insert(p_t(23, "Minolta AF 200mm F4 Macro APO G"));
        choices.insert(p_t(24, "Minolta/Sony AF 24-105mm F3.5-4.5 (D) or Sigma or Tamron Lens"));
        choices.insert(p_t(24, "Sigma 18-50mm F2.8"));
        choices.insert(p_t(24, "Sigma 17-70mm F2.8-4.5 (D)"));
        choices.insert(p_t(24, "Sigma 20-40mm F2.8 EX DG Aspherical IF"));
        choices.insert(p_t(24, "Sigma 18-200mm F3.5-6.3 DC"));
        choices.insert(p_t(24, "Sigma DC 18-125mm F4-5,6 D"));
        choices.insert(p_t(24, "Tamron SP AF 28-75mm F2.8 XR Di LD Aspherical [IF] Macro"));
        choices.insert(p_t(25, "Minolta AF 100-300mm F4.5-5.6 APO (D) or Sigma Lens"));
        choices.insert(p_t(25, "Sigma 100-300mm F4 EX (APO (D) or D IF)"));
        choices.insert(p_t(25, "Sigma 70mm F2.8 EX DG Macro"));
        choices.insert(p_t(25, "Sigma 20mm F1.8 EX DG Aspherical RF"));
        choices.insert(p_t(25, "Sigma 30mm F1.4 EX DC"));
        choices.insert(p_t(25, "Sigma 24mm F1.8 EX DG ASP Macro"));
        choices.insert(p_t(27, "Minolta AF 85mm F1.4 G (D)"));
        choices.insert(p_t(28, "Minolta/Sony AF 100mm F2.8 Macro (D) or Tamron Lens"));
        choices.insert(p_t(28, "Tamron SP AF 90mm F2.8 Di Macro"));
        choices.insert(p_t(28, "Tamron SP AF 180mm F3.5 Di LD [IF] Macro"));
        choices.insert(p_t(29, "Minolta/Sony AF 75-300mm F4.5-5.6 (D)"));
        choices.insert(p_t(30, "Minolta AF 28-80mm F3.5-5.6 (D) or Sigma Lens"));
        choices.insert(p_t(30, "Sigma AF 10-20mm F4-5.6 EX DC"));
        choices.insert(p_t(30, "Sigma AF 12-24mm F4.5-5.6 EX DG"));
        choices.insert(p_t(30, "Sigma 28-70mm EX DG F2.8"));
        choices.insert(p_t(30, "Sigma 55-200mm F4-5.6 DC"));
        choices.insert(p_t(31, "Minolta/Sony AF 50mm F2.8 Macro (D) or F3.5"));
        choices.insert(p_t(31, "Minolta/Sony AF 50mm F3.5 Macro"));
        choices.insert(p_t(32, "Minolta/Sony AF 300mm F2.8 G or 1.5x Teleconverter"));
        choices.insert(p_t(33, "Minolta/Sony AF 70-200mm F2.8 G"));
        choices.insert(p_t(35, "Minolta AF 85mm F1.4 G (D) Limited"));
        choices.insert(p_t(36, "Minolta AF 28-100mm F3.5-5.6 (D)"));
        choices.insert(p_t(38, "Minolta AF 17-35mm F2.8-4 (D)"));
        choices.insert(p_t(39, "Minolta AF 28-75mm F2.8 (D)"));
        choices.insert(p_t(40, "Minolta/Sony AF DT 18-70mm F3.5-5.6 (D)"));
        choices.insert(p_t(41, "Minolta/Sony AF DT 11-18mm F4.5-5.6 (D) or Tamron Lens"));
        choices.insert(p_t(41, "Tamron SP AF 11-18mm F4.5-5.6 Di II LD Aspherical IF"));
        choices.insert(p_t(42, "Minolta/Sony AF DT 18-200mm F3.5-6.3 (D)"));
        choices.insert(p_t(43, "Sony 35mm F1.4 G (SAL35F14G)"));
        choices.insert(p_t(44, "Sony 50mm F1.4 (SAL50F14)"));
        choices.insert(p_t(45, "Carl Zeiss Planar T* 85mm F1.4 ZA (SAL85F14Z)"));
        choices.insert(p_t(46, "Carl Zeiss Vario-Sonnar T* DT 16-80mm F3.5-4.5 ZA (SAL1680Z)"));
        choices.insert(p_t(47, "Carl Zeiss Sonnar T* 135mm F1.8 ZA (SAL135F18Z)"));
        choices.insert(p_t(48, "Carl Zeiss Vario-Sonnar T* 24-70mm F2.8 ZA SSM (SAL2470Z) or ZA SSM II"));
        choices.insert(p_t(48, "Carl Zeiss Vario-Sonnar T* 24-70mm F2.8 ZA SSM II (SAL2470Z2)"));
        choices.insert(p_t(49, "Sony DT 55-200mm F4-5.6 (SAL55200)"));
        choices.insert(p_t(50, "Sony DT 18-250mm F3.5-6.3 (SAL18250)"));
        choices.insert(p_t(51, "Sony DT 16-105mm F3.5-5.6 (SAL16105)"));
        choices.insert(p_t(52, "Sony 70-300mm F4.5-5.6 G SSM (SAL70300G) or G SSM II or Tamron Lens"));
        choices.insert(p_t(52, "Sony 70-300mm F4.5-5.6 G SSM II (SAL70300G2)"));
        choices.insert(p_t(52, "Tamron SP 70-300mm F4-5.6 Di USD"));
        choices.insert(p_t(53, "Sony 70-400mm F4-5.6 G SSM (SAL70400G)"));
        choices.insert(p_t(54, "Carl Zeiss Vario-Sonnar T* 16-35mm F2.8 ZA SSM (SAL1635Z) or ZA SSM II"));
        choices.insert(p_t(54, "Carl Zeiss Vario-Sonnar T* 16-35mm F2.8 ZA SSM II (SAL1635Z2)"));
        choices.insert(p_t(55, "Sony DT 18-55mm F3.5-5.6 SAM (SAL1855) or SAM II"));
        choices.insert(p_t(55, "Sony DT 18-55mm F3.5-5.6 SAM II (SAL18552)"));
        choices.insert(p_t(56, "Sony DT 55-200mm F4-5.6 SAM (SAL55200-2)"));
        choices.insert(p_t(57, "Sony DT 50mm F1.8 SAM (SAL50F18) or Tamron Lens"));
        choices.insert(p_t(57, "Tamron SP AF 60mm F2 Di II LD [IF] Macro 1:1"));
        choices.insert(p_t(57, "Tamron 18-270mm F3.5-6.3 Di II PZD"));
        choices.insert(p_t(58, "Sony DT 30mm F2.8 Macro SAM (SAL30M28)"));
        choices.insert(p_t(59, "Sony 28-75mm F2.8 SAM (SAL2875)"));
        choices.insert(p_t(60, "Carl Zeiss Distagon T* 24mm F2 ZA SSM (SAL24F20Z)"));
        choices.insert(p_t(61, "Sony 85mm F2.8 SAM (SAL85F28)"));
        choices.insert(p_t(62, "Sony DT 35mm F1.8 SAM (SAL35F18)"));
        choices.insert(p_t(63, "Sony DT 16-50mm F2.8 SSM (SAL1650)"));
        choices.insert(p_t(64, "Sony 500mm F4 G SSM (SAL500F40G)"));
        choices.insert(p_t(65, "Sony DT 18-135mm F3.5-5.6 SAM (SAL18135)"));
        choices.insert(p_t(66, "Sony 300mm F2.8 G SSM II (SAL300F28G2)"));
        choices.insert(p_t(67, "Sony 70-200mm F2.8 G SSM II (SAL70200G2)"));
        choices.insert(p_t(68, "Sony DT 55-300mm F4.5-5.6 SAM (SAL55300)"));
        choices.insert(p_t(69, "Sony 70-400mm F4-5.6 G SSM II (SAL70400G2)"));
        choices.insert(p_t(70, "Carl Zeiss Planar T* 50mm F1.4 ZA SSM (SAL50F14Z)"));
        choices.insert(p_t(128, "Tamron or Sigma Lens (128)"));
        choices.insert(p_t(128, "Tamron AF 18-200mm F3.5-6.3 XR Di II LD Aspherical [IF] Macro"));
        choices.insert(p_t(128, "Tamron AF 28-300mm F3.5-6.3 XR Di LD Aspherical [IF] Macro"));
        choices.insert(p_t(128, "Tamron 80-300mm F3.5-6.3"));
        choices.insert(p_t(128, "Tamron AF 28-200mm F3.8-5.6 XR Di Aspherical [IF] Macro"));
        choices.insert(p_t(128, "Tamron SP AF 17-35mm F2.8-4 Di LD Aspherical IF"));
        choices.insert(p_t(128, "Sigma AF 50-150mm F2.8 EX DC APO HSM II"));
        choices.insert(p_t(128, "Sigma 10-20mm F3.5 EX DC HSM"));
        choices.insert(p_t(128, "Sigma 70-200mm F2.8 II EX DG APO MACRO HSM"));
        choices.insert(p_t(128, "Sigma 10mm F2.8 EX DC HSM Fisheye"));
        choices.insert(p_t(128, "Sigma 50mm F1.4 EX DG HSM"));
        choices.insert(p_t(128, "Sigma 85mm F1.4 EX DG HSM"));
        choices.insert(p_t(128, "Sigma 24-70mm F2.8 IF EX DG HSM"));
        choices.insert(p_t(128, "Sigma 18-250mm F3.5-6.3 DC OS HSM"));
        choices.insert(p_t(128, "Sigma 17-50mm F2.8 EX DC HSM"));
        choices.insert(p_t(128, "Sigma 17-70mm F2.8-4 DC Macro HSM"));
        choices.insert(p_t(128, "Sigma 150mm F2.8 EX DG OS HSM APO Macro"));
        choices.insert(p_t(128, "Sigma 150-500mm F5-6.3 APO DG OS HSM"));
        choices.insert(p_t(128, "Tamron AF 28-105mm F4-5.6 [IF]"));
        choices.insert(p_t(128, "Sigma 35mm F1.4 DG HSM"));
        choices.insert(p_t(128, "Sigma 18-35mm F1.8 DC HSM"));
        choices.insert(p_t(129, "Tamron Lens (129)"));
        choices.insert(p_t(129, "Tamron 200-400mm F5.6 LD"));
        choices.insert(p_t(129, "Tamron 70-300mm F4-5.6 LD"));
        choices.insert(p_t(131, "Tamron 20-40mm F2.7-3.5 SP Aspherical IF"));
        choices.insert(p_t(135, "Vivitar 28-210mm F3.5-5.6"));
        choices.insert(p_t(136, "Tokina EMZ M100 AF 100mm F3.5"));
        choices.insert(p_t(137, "Cosina 70-210mm F2.8-4 AF"));
        choices.insert(p_t(138, "Soligor 19-35mm F3.5-4.5"));
        choices.insert(p_t(139, "Tokina AF 28-300mm F4-6.3"));
        choices.insert(p_t(142, "Voigtlander 70-300mm F4.5-5.6"));
        choices.insert(p_t(146, "Voigtlander Macro APO-Lanthar 125mm F2.5 SL"));
        choices.insert(p_t(194, "Tamron SP AF 17-50mm F2.8 XR Di II LD Aspherical [IF]"));
        choices.insert(p_t(203, "Tamron SP 70-200mm F2.8 Di USD"));
        choices.insert(p_t(204, "Tamron SP 24-70mm F2.8 Di USD"));
        choices.insert(p_t(213, "Tamron 16-300mm F3.5-6.3 Di II PZD"));
        choices.insert(p_t(214, "Tamron SP 150-600mm F5-6.3 Di USD"));
        choices.insert(p_t(224, "Tamron SP 90mm F2.8 Di Macro 1:1 USD"));
        choices.insert(p_t(255, "Tamron Lens (255)"));
        choices.insert(p_t(255, "Tamron SP AF 17-50mm F2.8 XR Di II LD Aspherical"));
        choices.insert(p_t(255, "Tamron AF 18-250mm F3.5-6.3 XR Di II LD"));
        choices.insert(p_t(255, "Tamron AF 55-200mm F4-5.6 Di II LD Macro"));
        choices.insert(p_t(255, "Tamron AF 70-300mm F4-5.6 Di LD Macro 1:2"));
        choices.insert(p_t(255, "Tamron SP AF 200-500mm F5.0-6.3 Di LD IF"));
        choices.insert(p_t(255, "Tamron SP AF 10-24mm F3.5-4.5 Di II LD Aspherical IF"));
        choices.insert(p_t(255, "Tamron SP AF 70-200mm F2.8 Di LD IF Macro"));
        choices.insert(p_t(255, "Tamron SP AF 28-75mm F2.8 XR Di LD Aspherical IF"));
        choices.insert(p_t(255, "Tamron AF 90-300mm F4.5-5.6 Telemacro"));
        choices.insert(p_t(2550, "Minolta AF 50mm F1.7"));
        choices.insert(p_t(2551, "Minolta AF 35-70mm F4 or Other Lens"));
        choices.insert(p_t(2551, "Sigma UC AF 28-70mm F3.5-4.5"));
        choices.insert(p_t(2551, "Sigma AF 28-70mm F2.8"));
        choices.insert(p_t(2551, "Sigma M-AF 70-200mm F2.8 EX Aspherical"));
        choices.insert(p_t(2551, "Quantaray M-AF 35-80mm F4-5.6"));
        choices.insert(p_t(2551, "Tokina 28-70mm F2.8-4.5 AF"));
        choices.insert(p_t(2552, "Minolta AF 28-85mm F3.5-4.5 or Other Lens"));
        choices.insert(p_t(2552, "Tokina 19-35mm F3.5-4.5"));
        choices.insert(p_t(2552, "Tokina 28-70mm F2.8 AT-X"));
        choices.insert(p_t(2552, "Tokina 80-400mm F4.5-5.6 AT-X AF II 840"));
        choices.insert(p_t(2552, "Tokina AF PRO 28-80mm F2.8 AT-X 280"));
        choices.insert(p_t(2552, "Tokina AT-X PRO [II] AF 28-70mm F2.6-2.8 270"));
        choices.insert(p_t(2552, "Tamron AF 19-35mm F3.5-4.5"));
        choices.insert(p_t(2552, "Angenieux AF 28-70mm F2.6"));
        choices.insert(p_t(2552, "Tokina AT-X 17 AF 17mm F3.5"));
        choices.insert(p_t(2552, "Tokina 20-35mm F3.5-4.5 II AF"));
        choices.insert(p_t(2553, "Minolta AF 28-135mm F4-4.5 or Sigma Lens"));
        choices.insert(p_t(2553, "Sigma ZOOM-alpha 35-135mm F3.5-4.5"));
        choices.insert(p_t(2553, "Sigma 28-105mm F2.8-4 Aspherical"));
        choices.insert(p_t(2553, "Sigma 28-105mm F4-5.6 UC"));
        choices.insert(p_t(2554, "Minolta AF 35-105mm F3.5-4.5"));
        choices.insert(p_t(2555, "Minolta AF 70-210mm F4 Macro or Sigma Lens"));
        choices.insert(p_t(2555, "Sigma 70-210mm F4-5.6 APO"));
        choices.insert(p_t(2555, "Sigma M-AF 70-200mm F2.8 EX APO"));
        choices.insert(p_t(2555, "Sigma 75-200mm F2.8-3.5"));
        choices.insert(p_t(2556, "Minolta AF 135mm F2.8"));
        choices.insert(p_t(2557, "Minolta/Sony AF 28mm F2.8"));
        choices.insert(p_t(2558, "Minolta AF 24-50mm F4"));
        choices.insert(p_t(2560, "Minolta AF 100-200mm F4.5"));
        choices.insert(p_t(2561, "Minolta AF 75-300mm F4.5-5.6 or Sigma Lens"));
        choices.insert(p_t(2561, "Sigma 70-300mm F4-5.6 DL Macro"));
        choices.insert(p_t(2561, "Sigma 300mm F4 APO Macro"));
        choices.insert(p_t(2561, "Sigma AF 500mm F4.5 APO"));
        choices.insert(p_t(2561, "Sigma AF 170-500mm F5-6.3 APO Aspherical"));
        choices.insert(p_t(2561, "Tokina AT-X AF 300mm F4"));
        choices.insert(p_t(2561, "Tokina AT-X AF 400mm F5.6 SD"));
        choices.insert(p_t(2561, "Tokina AF 730 II 75-300mm F4.5-5.6"));
        choices.insert(p_t(2561, "Sigma 800mm F5.6 APO"));
        choices.insert(p_t(2561, "Sigma AF 400mm F5.6 APO Macro"));
        choices.insert(p_t(2562, "Minolta AF 50mm F1.4 [New]"));
        choices.insert(p_t(2563, "Minolta AF 300mm F2.8 APO or Sigma Lens"));
        choices.insert(p_t(2563, "Sigma AF 50-500mm F4-6.3 EX DG APO"));
        choices.insert(p_t(2563, "Sigma AF 170-500mm F5-6.3 APO Aspherical"));
        choices.insert(p_t(2563, "Sigma AF 500mm F4.5 EX DG APO"));
        choices.insert(p_t(2563, "Sigma 400mm F5.6 APO"));
        choices.insert(p_t(2564, "Minolta AF 50mm F2.8 Macro or Sigma Lens"));
        choices.insert(p_t(2564, "Sigma 50mm F2.8 EX Macro"));
        choices.insert(p_t(2565, "Minolta AF 600mm F4"));
        choices.insert(p_t(2566, "Minolta AF 24mm F2.8 or Sigma Lens"));
        choices.insert(p_t(2566, "Sigma 17-35mm F2.8-4 EX Aspherical"));
        choices.insert(p_t(2572, "Minolta/Sony AF 500mm F8 Reflex"));
        choices.insert(p_t(2578, "Minolta/Sony AF 16mm F2.8 Fisheye or Sigma Lens"));
        choices.insert(p_t(2578, "Sigma 8mm F4 EX [DG] Fisheye"));
        choices.insert(p_t(2578, "Sigma 14mm F3.5"));
        choices.insert(p_t(2578, "Sigma 15mm F2.8 Fisheye"));
        choices.insert(p_t(2579, "Minolta/Sony AF 20mm F2.8 or Tokina Lens"));
        choices.insert(p_t(2579, "Tokina AT-X Pro DX 11-16mm F2.8"));
        choices.insert(p_t(2581, "Minolta AF 100mm F2.8 Macro [New] or Sigma or Tamron Lens"));
        choices.insert(p_t(2581, "Sigma AF 90mm F2.8 Macro"));
        choices.insert(p_t(2581, "Sigma AF 105mm F2.8 EX [DG] Macro"));
        choices.insert(p_t(2581, "Sigma 180mm F5.6 Macro"));
        choices.insert(p_t(2581, "Sigma 180mm F3.5 EX DG Macro"));
        choices.insert(p_t(2581, "Tamron 90mm F2.8 Macro"));
        choices.insert(p_t(2585, "Minolta AF 35-105mm F3.5-4.5 New or Tamron Lens"));
        choices.insert(p_t(2585, "Beroflex 35-135mm F3.5-4.5"));
        choices.insert(p_t(2585, "Tamron 24-135mm F3.5-5.6"));
        choices.insert(p_t(2588, "Minolta AF 70-210mm F3.5-4.5"));
        choices.insert(p_t(2589, "Minolta AF 80-200mm F2.8 APO or Tokina Lens"));
        choices.insert(p_t(2589, "Tokina 80-200mm F2.8"));
        choices.insert(p_t(2590, "Minolta AF 200mm F2.8 G APO + Minolta AF 1.4x APO or Other Lens + 1.4x"));
        choices.insert(p_t(2590, "Minolta AF 600mm F4 HS-APO G + Minolta AF 1.4x APO"));
        choices.insert(p_t(2591, "Minolta AF 35mm F1.4"));
        choices.insert(p_t(2592, "Minolta AF 85mm F1.4 G (D)"));
        choices.insert(p_t(2593, "Minolta AF 200mm F2.8 G APO"));
        choices.insert(p_t(2594, "Minolta AF 3x-1x F1.7-2.8 Macro"));
        choices.insert(p_t(2596, "Minolta AF 28mm F2"));
        choices.insert(p_t(2597, "Minolta AF 35mm F2 [New]"));
        choices.insert(p_t(2598, "Minolta AF 100mm F2"));
        choices.insert(p_t(2601, "Minolta AF 200mm F2.8 G APO + Minolta AF 2x APO or Other Lens + 2x"));
        choices.insert(p_t(2601, "Minolta AF 600mm F4 HS-APO G + Minolta AF 2x APO"));
        choices.insert(p_t(2604, "Minolta AF 80-200mm F4.5-5.6"));
        choices.insert(p_t(2605, "Minolta AF 35-80mm F4-5.6"));
        choices.insert(p_t(2606, "Minolta AF 100-300mm F4.5-5.6"));
        choices.insert(p_t(2607, "Minolta AF 35-80mm F4-5.6"));
        choices.insert(p_t(2608, "Minolta AF 300mm F2.8 HS-APO G"));
        choices.insert(p_t(2609, "Minolta AF 600mm F4 HS-APO G"));
        choices.insert(p_t(2612, "Minolta AF 200mm F2.8 HS-APO G"));
        choices.insert(p_t(2613, "Minolta AF 50mm F1.7 New"));
        choices.insert(p_t(2615, "Minolta AF 28-105mm F3.5-4.5 xi"));
        choices.insert(p_t(2616, "Minolta AF 35-200mm F4.5-5.6 xi"));
        choices.insert(p_t(2618, "Minolta AF 28-80mm F4-5.6 xi"));
        choices.insert(p_t(2619, "Minolta AF 80-200mm F4.5-5.6 xi"));
        choices.insert(p_t(2620, "Minolta AF 28-70mm F2.8 G"));
        choices.insert(p_t(2621, "Minolta AF 100-300mm F4.5-5.6 xi"));
        choices.insert(p_t(2624, "Minolta AF 35-80mm F4-5.6 Power Zoom"));
        choices.insert(p_t(2628, "Minolta AF 80-200mm F2.8 G"));
        choices.insert(p_t(2629, "Minolta AF 85mm F1.4 New"));
        choices.insert(p_t(2631, "Minolta/Sony AF 100-300mm F4.5-5.6 APO"));
        choices.insert(p_t(2632, "Minolta AF 24-50mm F4 New"));
        choices.insert(p_t(2638, "Minolta AF 50mm F2.8 Macro New"));
        choices.insert(p_t(2639, "Minolta AF 100mm F2.8 Macro"));
        choices.insert(p_t(2641, "Minolta/Sony AF 20mm F2.8 New"));
        choices.insert(p_t(2642, "Minolta AF 24mm F2.8 New"));
        choices.insert(p_t(2644, "Minolta AF 100-400mm F4.5-6.7 APO"));
        choices.insert(p_t(2662, "Minolta AF 50mm F1.4 New"));
        choices.insert(p_t(2667, "Minolta AF 35mm F2 New"));
        choices.insert(p_t(2668, "Minolta AF 28mm F2 New"));
        choices.insert(p_t(2672, "Minolta AF 24-105mm F3.5-4.5 (D)"));
        choices.insert(p_t(3046, "Metabones Canon EF Speed Booster"));
        choices.insert(p_t(4567, "Tokina 70-210mm F4-5.6"));
        choices.insert(p_t(4571, "Vivitar 70-210mm F4.5-5.6"));
        choices.insert(p_t(4574, "2x Teleconverter or Tamron or Tokina Lens"));
        choices.insert(p_t(4574, "Tamron SP AF 90mm F2.5"));
        choices.insert(p_t(4574, "Tokina RF 500mm F8.0 x2"));
        choices.insert(p_t(4574, "Tokina 300mm F2.8 x2"));
        choices.insert(p_t(4575, "1.4x Teleconverter"));
        choices.insert(p_t(4585, "Tamron SP AF 300mm F2.8 LD IF"));
        choices.insert(p_t(4586, "Tamron SP AF 35-105mm F2.8 LD Aspherical IF"));
        choices.insert(p_t(4587, "Tamron AF 70-210mm F2.8 SP LD"));
        choices.insert(p_t(6118, "Metabones Canon EF Adapter"));
        choices.insert(p_t(6553, "E-Mount, T-Mount, Other Lens or no lens"));
        choices.insert(p_t(6553, "Sony E 16mm F2.8"));
        choices.insert(p_t(6553, "Sony E 18-55mm F3.5-5.6 OSS"));
        choices.insert(p_t(6553, "Sony E 55-210mm F4.5-6.3 OSS"));
        choices.insert(p_t(6553, "Sony E 18-200mm F3.5-6.3 OSS"));
        choices.insert(p_t(6553, "Sony E 30mm F3.5 Macro"));
        choices.insert(p_t(6553, "Sony E 24mm F1.8 ZA"));
        choices.insert(p_t(6553, "Sony E 50mm F1.8 OSS"));
        choices.insert(p_t(6553, "Sony E 16-70mm F4 ZA OSS"));
        choices.insert(p_t(6553, "Sony E 10-18mm F4 OSS"));
        choices.insert(p_t(6553, "Sony E PZ 16-50mm F3.5-5.6 OSS"));
        choices.insert(p_t(6553, "Sony FE 35mm F2.8 ZA"));
        choices.insert(p_t(6553, "Sony FE 24-70mm F4 ZA OSS"));
        choices.insert(p_t(6553, "Sony E 18-200mm F3.5-6.3 OSS LE"));
        choices.insert(p_t(6553, "Sony E 20mm F2.8"));
        choices.insert(p_t(6553, "Sony E 35mm F1.8 OSS"));
        choices.insert(p_t(6553, "Sony E PZ 18-105mm F4 G OSS"));
        choices.insert(p_t(6553, "Sony FE 90mm F2.8 Macro G OSS"));
        choices.insert(p_t(6553, "Sony E 18-50mm F4-5.6"));
        choices.insert(p_t(6553, "Sony E PZ 18-200mm F3.5-6.3 OSS"));
        choices.insert(p_t(6553, "Sony FE 55mm F1.8 ZA"));
        choices.insert(p_t(6553, "Sony FE 70-200mm F4 G OSS"));
        choices.insert(p_t(6553, "Sony FE 16-35mm F4 ZA OSS"));
        choices.insert(p_t(6553, "Sony FE 28-70mm F3.5-5.6 OSS"));
        choices.insert(p_t(6553, "Sony FE 35mm F1.4 ZA"));
        choices.insert(p_t(6553, "Sony FE 24-240mm F3.5-6.3 OSS"));
        choices.insert(p_t(6553, "Sony FE 28mm F2"));
        choices.insert(p_t(6553, "Sony FE PZ 28-135mm F4 G OSS"));
        choices.insert(p_t(6553, "Sony FE 21mm F2.8 (SEL28F20 + SEL075UWC)"));
        choices.insert(p_t(6553, "Sony FE 16mm F3.5 Fisheye (SEL28F20 + SEL057FEC)"));
        choices.insert(p_t(6553, "Sigma 19mm F2.8 [EX] DN"));
        choices.insert(p_t(6553, "Sigma 30mm F2.8 [EX] DN"));
        choices.insert(p_t(6553, "Sigma 60mm F2.8 DN"));
        choices.insert(p_t(6553, "Tamron 18-200mm F3.5-6.3 Di III VC"));
        choices.insert(p_t(6553, "Zeiss Batis 25mm F2"));
        choices.insert(p_t(6553, "Zeiss Batis 85mm F1.8"));
        choices.insert(p_t(6553, "Zeiss Loxia 35mm F2"));
        choices.insert(p_t(6553, "Zeiss Loxia 50mm F2"));
        choices.insert(p_t(6553, "Zeiss Touit 12mm F2.8"));
        choices.insert(p_t(6553, "Zeiss Touit 32mm F1.8"));
        choices.insert(p_t(6553, "Zeiss Touit 50mm F2.8 Macro"));
        choices.insert(p_t(6553, "Arax MC 35mm F2.8 Tilt+Shift"));
        choices.insert(p_t(6553, "Arax MC 80mm F2.8 Tilt+Shift"));
        choices.insert(p_t(6553, "Zenitar MF 16mm F2.8 Fisheye M42"));
        choices.insert(p_t(6553, "Samyang 500mm Mirror F8.0"));
        choices.insert(p_t(6553, "Pentacon Auto 135mm F2.8"));
        choices.insert(p_t(6553, "Pentacon Auto 29mm F2.8"));
        choices.insert(p_t(6553, "Helios 44-2 58mm F2.0"));
        choices.insert(p_t(25501, "Minolta AF 50mm F1.7"));
        choices.insert(p_t(25511, "Minolta AF 35-70mm F4 or Other Lens"));
        choices.insert(p_t(25511, "Sigma UC AF 28-70mm F3.5-4.5"));
        choices.insert(p_t(25511, "Sigma AF 28-70mm F2.8"));
        choices.insert(p_t(25511, "Sigma M-AF 70-200mm F2.8 EX Aspherical"));
        choices.insert(p_t(25511, "Quantaray M-AF 35-80mm F4-5.6"));
        choices.insert(p_t(25511, "Tokina 28-70mm F2.8-4.5 AF"));
        choices.insert(p_t(25521, "Minolta AF 28-85mm F3.5-4.5 or Other Lens"));
        choices.insert(p_t(25521, "Tokina 19-35mm F3.5-4.5"));
        choices.insert(p_t(25521, "Tokina 28-70mm F2.8 AT-X"));
        choices.insert(p_t(25521, "Tokina 80-400mm F4.5-5.6 AT-X AF II 840"));
        choices.insert(p_t(25521, "Tokina AF PRO 28-80mm F2.8 AT-X 280"));
        choices.insert(p_t(25521, "Tokina AT-X PRO [II] AF 28-70mm F2.6-2.8 270"));
        choices.insert(p_t(25521, "Tamron AF 19-35mm F3.5-4.5"));
        choices.insert(p_t(25521, "Angenieux AF 28-70mm F2.6"));
        choices.insert(p_t(25521, "Tokina AT-X 17 AF 17mm F3.5"));
        choices.insert(p_t(25521, "Tokina 20-35mm F3.5-4.5 II AF"));
        choices.insert(p_t(25531, "Minolta AF 28-135mm F4-4.5 or Sigma Lens"));
        choices.insert(p_t(25531, "Sigma ZOOM-alpha 35-135mm F3.5-4.5"));
        choices.insert(p_t(25531, "Sigma 28-105mm F2.8-4 Aspherical"));
        choices.insert(p_t(25531, "Sigma 28-105mm F4-5.6 UC"));
        choices.insert(p_t(25541, "Minolta AF 35-105mm F3.5-4.5"));
        choices.insert(p_t(25551, "Minolta AF 70-210mm F4 Macro or Sigma Lens"));
        choices.insert(p_t(25551, "Sigma 70-210mm F4-5.6 APO"));
        choices.insert(p_t(25551, "Sigma M-AF 70-200mm F2.8 EX APO"));
        choices.insert(p_t(25551, "Sigma 75-200mm F2.8-3.5"));
        choices.insert(p_t(25561, "Minolta AF 135mm F2.8"));
        choices.insert(p_t(25571, "Minolta/Sony AF 28mm F2.8"));
        choices.insert(p_t(25581, "Minolta AF 24-50mm F4"));
        choices.insert(p_t(25601, "Minolta AF 100-200mm F4.5"));
        choices.insert(p_t(25611, "Minolta AF 75-300mm F4.5-5.6 or Sigma Lens"));
        choices.insert(p_t(25611, "Sigma 70-300mm F4-5.6 DL Macro"));
        choices.insert(p_t(25611, "Sigma 300mm F4 APO Macro"));
        choices.insert(p_t(25611, "Sigma AF 500mm F4.5 APO"));
        choices.insert(p_t(25611, "Sigma AF 170-500mm F5-6.3 APO Aspherical"));
        choices.insert(p_t(25611, "Tokina AT-X AF 300mm F4"));
        choices.insert(p_t(25611, "Tokina AT-X AF 400mm F5.6 SD"));
        choices.insert(p_t(25611, "Tokina AF 730 II 75-300mm F4.5-5.6"));
        choices.insert(p_t(25611, "Sigma 800mm F5.6 APO"));
        choices.insert(p_t(25611, "Sigma AF 400mm F5.6 APO Macro"));
        choices.insert(p_t(25621, "Minolta AF 50mm F1.4 [New]"));
        choices.insert(p_t(25631, "Minolta AF 300mm F2.8 APO or Sigma Lens"));
        choices.insert(p_t(25631, "Sigma AF 50-500mm F4-6.3 EX DG APO"));
        choices.insert(p_t(25631, "Sigma AF 170-500mm F5-6.3 APO Aspherical"));
        choices.insert(p_t(25631, "Sigma AF 500mm F4.5 EX DG APO"));
        choices.insert(p_t(25631, "Sigma 400mm F5.6 APO"));
        choices.insert(p_t(25641, "Minolta AF 50mm F2.8 Macro or Sigma Lens"));
        choices.insert(p_t(25641, "Sigma 50mm F2.8 EX Macro"));
        choices.insert(p_t(25651, "Minolta AF 600mm F4"));
        choices.insert(p_t(25661, "Minolta AF 24mm F2.8 or Sigma Lens"));
        choices.insert(p_t(25661, "Sigma 17-35mm F2.8-4 EX Aspherical"));
        choices.insert(p_t(25721, "Minolta/Sony AF 500mm F8 Reflex"));
        choices.insert(p_t(25781, "Minolta/Sony AF 16mm F2.8 Fisheye or Sigma Lens"));
        choices.insert(p_t(25781, "Sigma 8mm F4 EX [DG] Fisheye"));
        choices.insert(p_t(25781, "Sigma 14mm F3.5"));
        choices.insert(p_t(25781, "Sigma 15mm F2.8 Fisheye"));
        choices.insert(p_t(25791, "Minolta/Sony AF 20mm F2.8 or Tokina Lens"));
        choices.insert(p_t(25791, "Tokina AT-X Pro DX 11-16mm F2.8"));
        choices.insert(p_t(25811, "Minolta AF 100mm F2.8 Macro [New] or Sigma or Tamron Lens"));
        choices.insert(p_t(25811, "Sigma AF 90mm F2.8 Macro"));
        choices.insert(p_t(25811, "Sigma AF 105mm F2.8 EX [DG] Macro"));
        choices.insert(p_t(25811, "Sigma 180mm F5.6 Macro"));
        choices.insert(p_t(25811, "Sigma 180mm F3.5 EX DG Macro"));
        choices.insert(p_t(25811, "Tamron 90mm F2.8 Macro"));
        choices.insert(p_t(25851, "Beroflex 35-135mm F3.5-4.5"));
        choices.insert(p_t(25858, "Minolta AF 35-105mm F3.5-4.5 New or Tamron Lens"));
        choices.insert(p_t(25858, "Tamron 24-135mm F3.5-5.6"));
        choices.insert(p_t(25881, "Minolta AF 70-210mm F3.5-4.5"));
        choices.insert(p_t(25891, "Minolta AF 80-200mm F2.8 APO or Tokina Lens"));
        choices.insert(p_t(25891, "Tokina 80-200mm F2.8"));
        choices.insert(p_t(25901, "Minolta AF 200mm F2.8 G APO + Minolta AF 1.4x APO or Other Lens + 1.4x"));
        choices.insert(p_t(25901, "Minolta AF 600mm F4 HS-APO G + Minolta AF 1.4x APO"));
        choices.insert(p_t(25911, "Minolta AF 35mm F1.4"));
        choices.insert(p_t(25921, "Minolta AF 85mm F1.4 G (D)"));
        choices.insert(p_t(25931, "Minolta AF 200mm F2.8 G APO"));
        choices.insert(p_t(25941, "Minolta AF 3x-1x F1.7-2.8 Macro"));
        choices.insert(p_t(25961, "Minolta AF 28mm F2"));
        choices.insert(p_t(25971, "Minolta AF 35mm F2 [New]"));
        choices.insert(p_t(25981, "Minolta AF 100mm F2"));
        choices.insert(p_t(26011, "Minolta AF 200mm F2.8 G APO + Minolta AF 2x APO or Other Lens + 2x"));
        choices.insert(p_t(26011, "Minolta AF 600mm F4 HS-APO G + Minolta AF 2x APO"));
        choices.insert(p_t(26041, "Minolta AF 80-200mm F4.5-5.6"));
        choices.insert(p_t(26051, "Minolta AF 35-80mm F4-5.6"));
        choices.insert(p_t(26061, "Minolta AF 100-300mm F4.5-5.6"));
        choices.insert(p_t(26071, "Minolta AF 35-80mm F4-5.6"));
        choices.insert(p_t(26081, "Minolta AF 300mm F2.8 HS-APO G"));
        choices.insert(p_t(26091, "Minolta AF 600mm F4 HS-APO G"));
        choices.insert(p_t(26121, "Minolta AF 200mm F2.8 HS-APO G"));
        choices.insert(p_t(26131, "Minolta AF 50mm F1.7 New"));
        choices.insert(p_t(26151, "Minolta AF 28-105mm F3.5-4.5 xi"));
        choices.insert(p_t(26161, "Minolta AF 35-200mm F4.5-5.6 xi"));
        choices.insert(p_t(26181, "Minolta AF 28-80mm F4-5.6 xi"));
        choices.insert(p_t(26191, "Minolta AF 80-200mm F4.5-5.6 xi"));
        choices.insert(p_t(26201, "Minolta AF 28-70mm F2.8 G"));
        choices.insert(p_t(26211, "Minolta AF 100-300mm F4.5-5.6 xi"));
        choices.insert(p_t(26241, "Minolta AF 35-80mm F4-5.6 Power Zoom"));
        choices.insert(p_t(26281, "Minolta AF 80-200mm F2.8 G"));
        choices.insert(p_t(26291, "Minolta AF 85mm F1.4 New"));
        choices.insert(p_t(26311, "Minolta/Sony AF 100-300mm F4.5-5.6 APO"));
        choices.insert(p_t(26321, "Minolta AF 24-50mm F4 New"));
        choices.insert(p_t(26381, "Minolta AF 50mm F2.8 Macro New"));
        choices.insert(p_t(26391, "Minolta AF 100mm F2.8 Macro"));
        choices.insert(p_t(26411, "Minolta/Sony AF 20mm F2.8 New"));
        choices.insert(p_t(26421, "Minolta AF 24mm F2.8 New"));
        choices.insert(p_t(26441, "Minolta AF 100-400mm F4.5-6.7 APO"));
        choices.insert(p_t(26621, "Minolta AF 50mm F1.4 New"));
        choices.insert(p_t(26671, "Minolta AF 35mm F2 New"));
        choices.insert(p_t(26681, "Minolta AF 28mm F2 New"));
        choices.insert(p_t(26721, "Minolta AF 24-105mm F3.5-4.5 (D)"));
        choices.insert(p_t(30464, "Metabones Canon EF Speed Booster"));
        choices.insert(p_t(45671, "Tokina 70-210mm F4-5.6"));
        choices.insert(p_t(45711, "Vivitar 70-210mm F4.5-5.6"));
        choices.insert(p_t(45741, "2x Teleconverter or Tamron or Tokina Lens"));
        choices.insert(p_t(45741, "Tamron SP AF 90mm F2.5"));
        choices.insert(p_t(45741, "Tokina RF 500mm F8.0 x2"));
        choices.insert(p_t(45741, "Tokina 300mm F2.8 x2"));
        choices.insert(p_t(45751, "1.4x Teleconverter"));
        choices.insert(p_t(45851, "Tamron SP AF 300mm F2.8 LD IF"));
        choices.insert(p_t(45861, "Tamron SP AF 35-105mm F2.8 LD Aspherical IF"));
        choices.insert(p_t(45871, "Tamron AF 70-210mm F2.8 SP LD"));
        choices.insert(p_t(61184, "Metabones Canon EF Adapter"));
        choices.insert(p_t(65535, "E-Mount, T-Mount, Other Lens or no lens"));
        choices.insert(p_t(65535, "Sony E 16mm F2.8"));
        choices.insert(p_t(65535, "Sony E 18-55mm F3.5-5.6 OSS"));
        choices.insert(p_t(65535, "Sony E 55-210mm F4.5-6.3 OSS"));
        choices.insert(p_t(65535, "Sony E 18-200mm F3.5-6.3 OSS"));
        choices.insert(p_t(65535, "Sony E 30mm F3.5 Macro"));
        choices.insert(p_t(65535, "Sony E 24mm F1.8 ZA"));
        choices.insert(p_t(65535, "Sony E 50mm F1.8 OSS"));
        choices.insert(p_t(65535, "Sony E 16-70mm F4 ZA OSS"));
        choices.insert(p_t(65535, "Sony E 10-18mm F4 OSS"));
        choices.insert(p_t(65535, "Sony E PZ 16-50mm F3.5-5.6 OSS"));
        choices.insert(p_t(65535, "Sony FE 35mm F2.8 ZA"));
        choices.insert(p_t(65535, "Sony FE 24-70mm F4 ZA OSS"));
        choices.insert(p_t(65535, "Sony E 18-200mm F3.5-6.3 OSS LE"));
        choices.insert(p_t(65535, "Sony E 20mm F2.8"));
        choices.insert(p_t(65535, "Sony E 35mm F1.8 OSS"));
        choices.insert(p_t(65535, "Sony E PZ 18-105mm F4 G OSS"));
        choices.insert(p_t(65535, "Sony FE 90mm F2.8 Macro G OSS"));
        choices.insert(p_t(65535, "Sony E 18-50mm F4-5.6"));
        choices.insert(p_t(65535, "Sony E PZ 18-200mm F3.5-6.3 OSS"));
        choices.insert(p_t(65535, "Sony FE 55mm F1.8 ZA"));
        choices.insert(p_t(65535, "Sony FE 70-200mm F4 G OSS"));
        choices.insert(p_t(65535, "Sony FE 16-35mm F4 ZA OSS"));
        choices.insert(p_t(65535, "Sony FE 28-70mm F3.5-5.6 OSS"));
        choices.insert(p_t(65535, "Sony FE 35mm F1.4 ZA"));
        choices.insert(p_t(65535, "Sony FE 24-240mm F3.5-6.3 OSS"));
        choices.insert(p_t(65535, "Sony FE 28mm F2"));
        choices.insert(p_t(65535, "Sony FE PZ 28-135mm F4 G OSS"));
        choices.insert(p_t(65535, "Sony FE 21mm F2.8 (SEL28F20 + SEL075UWC)"));
        choices.insert(p_t(65535, "Sony FE 16mm F3.5 Fisheye (SEL28F20 + SEL057FEC)"));
        choices.insert(p_t(65535, "Sigma 19mm F2.8 [EX] DN"));
        choices.insert(p_t(65535, "Sigma 30mm F2.8 [EX] DN"));
        choices.insert(p_t(65535, "Sigma 60mm F2.8 DN"));
        choices.insert(p_t(65535, "Tamron 18-200mm F3.5-6.3 Di III VC"));
        choices.insert(p_t(65535, "Zeiss Batis 25mm F2"));
        choices.insert(p_t(65535, "Zeiss Batis 85mm F1.8"));
        choices.insert(p_t(65535, "Zeiss Loxia 35mm F2"));
        choices.insert(p_t(65535, "Zeiss Loxia 50mm F2"));
        choices.insert(p_t(65535, "Zeiss Touit 12mm F2.8"));
        choices.insert(p_t(65535, "Zeiss Touit 32mm F1.8"));
        choices.insert(p_t(65535, "Zeiss Touit 50mm F2.8 Macro"));
        choices.insert(p_t(65535, "Arax MC 35mm F2.8 Tilt+Shift"));
        choices.insert(p_t(65535, "Arax MC 80mm F2.8 Tilt+Shift"));
        choices.insert(p_t(65535, "Zenitar MF 16mm F2.8 Fisheye M42"));
        choices.insert(p_t(65535, "Samyang 500mm Mirror F8.0"));
        choices.insert(p_t(65535, "Pentacon Auto 135mm F2.8"));
        choices.insert(p_t(65535, "Pentacon Auto 29mm F2.8"));
        choices.insert(p_t(65535, "Helios 44-2 58mm F2.0"));
    }
...
public:
    SALensID2Interpreter ()
    {
        ...
        choices.insert(p_t(32787, "Sony E 18-200mm F3.5-6.3 OSS"));
        choices.insert(p_t(32788, "Sony E 30mm F3.5 Macro"));
        choices.insert(p_t(32789, "Sony E 24mm F1.8 ZA"));
        choices.insert(p_t(32790, "Sony E 50mm F1.8 OSS"));
        choices.insert(p_t(32791, "Sony E 16-70mm F4 ZA OSS"));
        choices.insert(p_t(32792, "Sony E 10-18mm F4 OSS"));
        choices.insert(p_t(32793, "Sony E PZ 16-50mm F3.5-5.6 OSS"));
        choices.insert(p_t(32794, "Sony FE 35mm F2.8 ZA"));
        choices.insert(p_t(32795, "Sony FE 24-70mm F4 ZA OSS"));
        choices.insert(p_t(32797, "Sony E 18-200mm F3.5-6.3 OSS LE"));
        choices.insert(p_t(32798, "Sony E 20mm F2.8"));
        choices.insert(p_t(32799, "Sony E 35mm F1.8 OSS"));
        choices.insert(p_t(32800, "Sony E PZ 18-105mm F4 G OSS"));
        choices.insert(p_t(32802, "Sony FE 90mm F2.8 Macro G OSS"));
        choices.insert(p_t(32803, "Sony E 18-50mm F4-5.6"));
        choices.insert(p_t(32807, "Sony E PZ 18-200mm F3.5-6.3 OSS"));
        choices.insert(p_t(32808, "Sony FE 55mm F1.8 ZA"));
        choices.insert(p_t(32810, "Sony FE 70-200mm F4 G OSS"));
        choices.insert(p_t(32811, "Sony FE 16-35mm F4 ZA OSS"));
        choices.insert(p_t(32813, "Sony FE 28-70mm F3.5-5.6 OSS"));
        choices.insert(p_t(32814, "Sony FE 35mm F1.4 ZA"));
        choices.insert(p_t(32815, "Sony FE 24-240mm F3.5-6.3 OSS"));
        choices.insert(p_t(32816, "Sony FE 28mm F2"));
        choices.insert(p_t(32817, "Sony FE PZ 28-135mm F4 G OSS"));
        choices.insert(p_t(32826, "Sony FE 21mm F2.8 (SEL28F20 + SEL075UWC)"));
        choices.insert(p_t(32827, "Sony FE 16mm F3.5 Fisheye (SEL28F20 + SEL057FEC)"));
        choices.insert(p_t(49216, "Zeiss Batis 25mm F2"));
        choices.insert(p_t(49217, "Zeiss Batis 85mm F1.8"));
    }
