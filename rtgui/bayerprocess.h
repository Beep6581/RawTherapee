...
class BayerProcess final : public ToolParamBlock,
...
public:
    ...
    void setAdjusterBehavior(bool falsecoloradd, bool iteradd,
        bool dualdemozecontrastadd, bool pssigmaadd, bool pssmoothadd,
        bool pseperisoadd);
