...
/*
 * Class handling the list of ThumbBrowserEntry objects and their position in it's
 * allocated space
 */
...
class ThumbBrowserBase : public Gtk::Grid
{
    ...
    public:
        ...
        void get_preferred_width_vfunc(
            int &minimum_width, int &natural_width) const final;
        ...
        Glib::RefPtr<Gtk::StyleContext> getStyle() { return style; }
        Gdk::RGBA getNormalTextColor() { return textn; }
        Gdk::RGBA getSelectedTextColor() { return texts; }
        Gdk::RGBA getNormalBgColor() { return bgn; }
        Gdk::RGBA getSelectedBgColor() { return bgs; }
...
public:
    enum eLocation { THLOC_BATCHQUEUE, THLOC_FILEBROWSER, THLOC_EDITOR } location;
...
protected:
    ...
    void buttonPressed(int x, int y, int button, GdkEventType type, int state, int clx,
...
public:
    ...
    void refreshThumbImages(); // refresh thumbnail sizes, re-generate thumbnail images,
                               // arrange and draw
    void refreshQuickThumbImages(); // refresh thumbnail sizes, re-generate thumbnail
                                    // images, arrange and draw
    ...
    virtual bool checkFilter(ThumbBrowserEntryBase *entry) const { return true; }
    ...
    Glib::RefPtr<Gtk::StyleContext> getStyle() { return internal.getStyle(); }
    Gdk::RGBA getNormalTextColor() { return internal.getNormalTextColor(); }
    Gdk::RGBA getSelectedTextColor() { return internal.getSelectedTextColor(); }
    Gdk::RGBA getNormalBgColor() { return internal.getNormalBgColor(); }
