...
class DirPyrDenoise final : public ToolParamBlock,
...
public:
    ...
    bool noiseComputed_();
    void noiseTilePrev(
        int tileX, int tileY, int prevX, int prevY, int sizeT, int sizeP) override;
    ...
    void setAdjusterBehavior(bool lumaadd, bool lumdetadd, bool chromaadd,
        bool chromaredadd, bool chromablueadd, bool gammaadd, bool passesadd);
