...
Retinex::Retinex() :
    FoldableToolPanel(this, TOOL_NAME, M("TP_RETINEX_LABEL"), false, true),
    lastmedianmap(false)
{
    ...
    complexmethodconn = complexmethod->signal_changed().connect(
        sigc::mem_fun(*this, &Retinex::complexmethodChanged));
    ...
    setExpandAlignProperties(
        retinexGrid, false, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(
        labmdh, false, false, Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    dhgrid->attach(*labmdh, 0, 0, 1, 1);

    retinexMethod = Gtk::manage(new MyComboBoxText());
    setExpandAlignProperties(
        retinexMethod, true, true, Gtk::ALIGN_FILL, Gtk::ALIGN_BASELINE);
    ...
    retinexMethodConn = retinexMethod->signal_changed().connect(
        sigc::mem_fun(*this, &Retinex::retinexMethodChanged));
    ...
    setExpandAlignProperties(
        retinexcolorspace, true, true, Gtk::ALIGN_FILL, Gtk::ALIGN_BASELINE);
    ...
    retinexColorSpaceConn = retinexcolorspace->signal_changed().connect(
        sigc::mem_fun(*this, &Retinex::retinexColorSpaceChanged));
    ...
    setExpandAlignProperties(
        labview, false, false, Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    viewgrid->attach(*labview, 0, 0, 1, 1);

    viewMethod = Gtk::manage(new MyComboBoxText());
    setExpandAlignProperties(
        viewMethod, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_BASELINE);
    ...
    viewMethodConn = viewMethod->signal_changed().connect(
        sigc::mem_fun(*this, &Retinex::viewMethodChanged));
    ...
    //   Gtk::Frame *maskFrame = Gtk::manage (new Gtk::Frame (M
    //   ("TP_RETINEX_LABEL_MASK")) );
    ...
    setExpandAlignProperties(
        labmap, false, false, Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    mapgrid->attach(*labmap, 0, 0, 1, 1);

    mapMethod = Gtk::manage(new MyComboBoxText());
    setExpandAlignProperties(
        mapMethod, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_BASELINE);
    ...
    mapMethodConn = mapMethod->signal_changed().connect(
        sigc::mem_fun(*this, &Retinex::mapMethodChanged));
    ...
    // Map Equalizer
    curveEditormap =
        new CurveEditorGroup(options.lastRetinexDir, M("TP_RETINEX_CONTEDIT_MAP"));
    setExpandAlignProperties(
        curveEditormap, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    ...
    mapshape = static_cast<DiagonalCurveEditor *>(
        curveEditormap->addCurve(CT_Diagonal, M("TP_RETINEX_CURVEEDITOR_MAP")));
    ...
    setExpandAlignProperties(
        highlights, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    maskGrid->attach(*highlights, 0, 2, 1, 1);
    highlights->show();

    h_tonalwidth =
        Gtk::manage(new Adjuster(M("TP_SHADOWSHLIGHTS_HLTONALW"), 10, 100, 1, 80));
    setExpandAlignProperties(
        h_tonalwidth, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    ...
    s_tonalwidth =
        Gtk::manage(new Adjuster(M("TP_SHADOWSHLIGHTS_SHTONALW"), 10, 100, 1, 80));
    setExpandAlignProperties(
        s_tonalwidth, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(
        expsettings, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    expsettings->signal_button_release_event().connect_notify(
        sigc::bind(sigc::mem_fun(this, &Retinex::foldAllButMe), expsettings));

    Gtk::Grid *settingsGrid = Gtk::manage(new Gtk::Grid());
    setExpandAlignProperties(
        settingsGrid, false, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    ...
    setExpandAlignProperties(
        equalFrame, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
// GTK318
    ...
    setExpandAlignProperties(
        curveEditorGD, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    ...
    cdshape = static_cast<DiagonalCurveEditor *>(
        curveEditorGD->addCurve(CT_Diagonal, M("TP_RETINEX_CURVEEDITOR_CD")));
    ...
    curveEditorGDH =
        new CurveEditorGroup(options.lastRetinexDir, M("TP_RETINEX_CONTEDIT_HSL"));
    setExpandAlignProperties(
        curveEditorGDH, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    ...
    cdshapeH = static_cast<DiagonalCurveEditor *>(
        curveEditorGDH->addCurve(CT_Diagonal, M("TP_RETINEX_CURVEEDITOR_CD")));
    ...
    // Hue equalizer
    curveEditorGH =
        new CurveEditorGroup(options.lastRetinexDir, M("TP_RETINEX_CONTEDIT_LH"));
    setExpandAlignProperties(
        curveEditorGH, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    curveEditorGH->setCurveListener(this);
    lhshape = static_cast<FlatCurveEditor *>(
        curveEditorGH->addCurve(CT_Flat, M("TP_RETINEX_CURVEEDITOR_LH")));
    ...
    setExpandAlignProperties(
        labgam, false, false, Gtk::ALIGN_START, Gtk::ALIGN_BASELINE);
    gamgrid->attach(*labgam, 0, 0, 1, 1);

    gammaretinex = Gtk::manage(new MyComboBoxText());
    setExpandAlignProperties(
        gammaretinex, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_BASELINE);
    ...
    gammaretinexConn = gammaretinex->signal_changed().connect(
        sigc::mem_fun(*this, &Retinex::gammaretinexChanged));
...
// GTK318
    ...
    setExpandAlignProperties(
        transmissionCurveEditorG, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    transmissionCurveEditorG->setCurveListener(this);
    transmissionShape = static_cast<FlatCurveEditor *>(
        transmissionCurveEditorG->addCurve(CT_Flat, "", nullptr, false, false));
    transmissionShape->setIdentityValue(0.);
    transmissionShape->setResetCurve(
        FlatCurveType(default_params.transmissionCurve.at(0)),
        default_params.transmissionCurve);
    ...
    medianmapConn = medianmap->signal_toggled().connect(
        sigc::mem_fun(*this, &Retinex::medianmapChanged));
...
// GTK318
    ...
    gaintransmissionCurve =
        new CurveEditorGroup(options.lastRetinexDir, M("TP_RETINEX_GAINTRANSMISSION"));
    setExpandAlignProperties(
        gaintransmissionCurve, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_START);
    gaintransmissionCurve->setCurveListener(this);
    gaintransmissionShape = static_cast<FlatCurveEditor *>(
        gaintransmissionCurve->addCurve(CT_Flat, "", nullptr, false, false));
    gaintransmissionShape->setIdentityValue(0.);
    gaintransmissionShape->setResetCurve(
        FlatCurveType(default_params.gaintransmissionCurve.at(0)),
        default_params.gaintransmissionCurve);
    ...
    neutralconn = neutral->signal_pressed().connect(
        sigc::mem_fun(*this, &Retinex::neutral_pressed));
    neutral->show();
    ...
    slope->setDelay(
        std::max(options.adjusterMinDelay, options.adjusterMaxDelay) * 2.5f);
...
void Retinex::minmaxChanged(double cdma, double cdmin, double mini, double maxi,
    double Tmean, double Tsigma, double Tmin, double Tmax)
{
    nextmin = cdmin;
    nextmax = cdma;
    nextminiT = mini;
...
void Retinex::updateLabel()
{
    if (!batchMode) {
        ...
        nY = nextmax;
        {
            mMLabels->set_text(Glib::ustring::compose(M("TP_RETINEX_MLABEL"),
...
void Retinex::updateTrans()
{
    if (!batchMode) {
        ...
        nS = nextsigma;
        {
            transLabels->set_text(Glib::ustring::compose(M("TP_RETINEX_TLABEL"),
...
void Retinex::write(ProcParams *pp, ParamsEdited *pedited)
{
    ...
    if (pedited) {
        pedited->retinex.complexmethod =
            complexmethod->get_active_text() != M("GENERAL_UNCHANGED");
        pedited->retinex.retinexMethod =
            retinexMethod->get_active_text() != M("GENERAL_UNCHANGED");
        pedited->retinex.retinexcolorspace =
            retinexcolorspace->get_active_text() != M("GENERAL_UNCHANGED");
        pedited->retinex.gammaretinex =
            gammaretinex->get_active_text() != M("GENERAL_UNCHANGED");
        pedited->retinex.mapMethod =
            mapMethod->get_active_text() != M("GENERAL_UNCHANGED");
        pedited->retinex.viewMethod =
            viewMethod->get_active_text() != M("GENERAL_UNCHANGED");
...
void Retinex::mapMethodChanged()
{
    ...
    if (!batchMode) {
        if (mapMethod->get_active_row_number() ==
            1 /*|| mapMethod->get_active_row_number() == 2*/) {
            curveEditormap->show();
            highlights->show();
            h_tonalwidth->show();
            shadows->show();
            ...
            radius->show();
                   ...
                   mapMethod->get_active_row_number() == 3) {
            curveEditormap->show();
            highlights->show();
            h_tonalwidth->show();
            shadows->show();
...
{
    if (!batchMode) {
        if (viewMethod->get_active_row_number() == 1 ||
            viewMethod->get_active_row_number() == 2) {
            // vart->hide();
            offs->hide();
            limd->hide();
            transmissionCurveEditorG->hide();
            ...
            */
            ...
            curveEditorGH->hide();
                   ...
                   viewMethod->get_active_row_number() == 4) {
            offs->hide();
            transmissionCurveEditorG->show();
            // vart->hide();
            curveEditorGH->hide();
...
void Retinex::retinexColorSpaceChanged()
{
    ...
    if (listener) {
        listener->panelChanged(
            EvretinexColorSpace, retinexcolorspace->get_active_text());
    }
}
...
void Retinex::setDefaults(const ProcParams *defParams, const ParamsEdited *pedited)
{
    ...
    if (pedited) {
        ...
        highlights->setDefaultEditedState(
            pedited->retinex.highlights ? Edited : UnEdited);
        h_tonalwidth->setDefaultEditedState(
            pedited->retinex.htonalwidth ? Edited : UnEdited);
        shadows->setDefaultEditedState(pedited->retinex.shadows ? Edited : UnEdited);
        s_tonalwidth->setDefaultEditedState(
            pedited->retinex.stonalwidth ? Edited : UnEdited);
...
void Retinex::setAdjusterBehavior(bool strAdd, bool neighAdd, bool limdAdd,
    bool offsAdd, bool vartAdd, bool gamAdd, bool slopeAdd)
{
...
void Retinex::updateCurveBackgroundHistogram(const LUTu &histToneCurve,
...
void Retinex::colorForValue(double valX, double valY,
