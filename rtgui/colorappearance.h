...
class ColorAppearance final : public ToolParamBlock,
...
public:
    ...
    void setAdjusterBehavior(bool degreeadd, bool adapscenadd, bool adaplumadd,
        bool badpixsladd, bool jlightadd, bool chromaadd, bool contrastadd,
