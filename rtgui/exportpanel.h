...
protected:
    ...
    /*      icm_input   = "(camera)";
            ...
            icm_gamma   = "default";
    */
    Gtk::CheckButton *bypass_dirpyrequalizer; // also could leave untouched but disable
                                              // only small radius adjustments
    // Gtk::CheckButton* bypass_raw_all_enhance;
    Gtk::CheckButton *bypass_wavelet; // also could leave untouched but disable only
                                      // small radius adjustments
    ...
    sigc::connection enabledconn, bypass_ALLconn, FastExportconn,
