...
public:
     ...
     * @param pos Location of the mouse, in percentage (i.e. [0;1] range) relative to
     * the full size image ; -1,-1 == out of the image
     ...
     * @param transform A semi-bitfield coarse transformation using #defines from
     * iimage.h
     */
