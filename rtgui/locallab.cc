...
//    expcontrast(Gtk::manage(new MyExpander(true,M("TP_LOCALLAB_LOC_CONTRAST")))),
    ...
    exptrcsh(Gtk::manage(new MyExpander(false, M("TP_LOCALLAB_EXPTRC")))),
...
//       wavshapecomp->setTooltip(M("TP_LOCALLAB_COMPRESS_TOOLTIP"));
    ...
    localedgMethodConn = localedgMethod->signal_changed().connect(sigc::mem_fun(*this, &Locallab::localedgMethodChanged));
    ...
    localneiMethodConn = localneiMethod->signal_changed().connect(sigc::mem_fun(*this, &Locallab::localneiMethodChanged));
...
void Locallab::foldAllButMe(GdkEventButton* event, MyExpander *expander)
{
    if (event->button == 3) {
        ...
        expgradsh->set_expanded(expgradsh == expander);
        exptrcsh->set_expanded(exptrcsh == expander);
        expgradvib->set_expanded(expgradvib == expander);
...
void Locallab::writeOptions(std::vector<int> &tpOpen)
{
    ...
    tpOpen.push_back(exptrcsh->get_expanded());
    ...
    tpOpen.push_back(expgradvib->get_expanded());
...
void Locallab::logencodChanged(float blackev, float whiteev, float sourceg, float targetg)
{
    GThreadLock lock;
...
void Locallab::updateToolState(std::vector<int> &tpOpen)
{
    if (tpOpen.size() >= 34) {
        ...
        exptrcsh->set_expanded(tpOpen.at(10));
            ...
            if (pp->locallab.nbspot > 0) {
                ...
                if (pp->locallab.selspot < (int)pp->locallab.spots.size()) {
                    ...
                    */
                    ...
                    pp->locallab.spots.at(pp->locallab.selspot).strengthw = strengthw->getValue();
                    pp->locallab.spots.at(pp->locallab.selspot).radiusw = radiusw->getValue();
                    pp->locallab.spots.at(pp->locallab.selspot).detailw = detailw->getValue();
                    pp->locallab.spots.at(pp->locallab.selspot).gradw = gradw->getValue();
                    pp->locallab.spots.at(pp->locallab.selspot).tloww = tloww->getValue();
                    pp->locallab.spots.at(pp->locallab.selspot).thigw = thigw->getValue();
                    pp->locallab.spots.at(pp->locallab.selspot).edgw = edgw->getValue();
                    pp->locallab.spots.at(pp->locallab.selspot).basew = basew->getValue();
                    pp->locallab.spots.at(pp->locallab.selspot).locedgwavcurve = wavshapeedg->getCurve();
                    ...
                    if (localedgMethod->get_active_row_number() == 0) {
                        pp->locallab.spots.at(pp->locallab.selspot).localedgMethod = "fir";
                    } else if (localedgMethod->get_active_row_number() == 1) {
                        pp->locallab.spots.at(pp->locallab.selspot).localedgMethod = "sec";
                    } else if (localedgMethod->get_active_row_number() == 2) {
                        pp->locallab.spots.at(pp->locallab.selspot).localedgMethod = "thr";
                    }

                    if (localneiMethod->get_active_row_number() == 0) {
                        pp->locallab.spots.at(pp->locallab.selspot).localneiMethod = "none";
                    } else if (localneiMethod->get_active_row_number() == 1) {
                        pp->locallab.spots.at(pp->locallab.selspot).localneiMethod = "low";
                    } else if (localneiMethod->get_active_row_number() == 2) {
                        pp->locallab.spots.at(pp->locallab.selspot).localneiMethod = "high";
                    }
...
//                        pe->locallab.spots.at(pp->locallab.selspot).mergeMethod = pe->locallab.spots.at(pp->locallab.selspot).mergeMethod || se->mergeMethod;
                        ...
                        pe->locallab.spots.at(pp->locallab.selspot).balanh = pe->locallab.spots.at(pp->locallab.selspot).balanh || se->balanh;
                        pe->locallab.spots.at(pp->locallab.selspot).colorde = pe->locallab.spots.at(pp->locallab.selspot).colorde || se->colorde;
                        ...
                        pe->locallab.spots.at(pp->locallab.selspot).strengthw = pe->locallab.spots.at(pp->locallab.selspot).strengthw || strengthw->getEditedState();
                        pe->locallab.spots.at(pp->locallab.selspot).radiusw = pe->locallab.spots.at(pp->locallab.selspot).radiusw || radiusw->getEditedState();
                        pe->locallab.spots.at(pp->locallab.selspot).detailw = pe->locallab.spots.at(pp->locallab.selspot).detailw || detailw->getEditedState();
                        pe->locallab.spots.at(pp->locallab.selspot).gradw = pe->locallab.spots.at(pp->locallab.selspot).gradw || gradw->getEditedState();
                        pe->locallab.spots.at(pp->locallab.selspot).tloww = pe->locallab.spots.at(pp->locallab.selspot).tloww || tloww->getEditedState();
                        pe->locallab.spots.at(pp->locallab.selspot).thigw = pe->locallab.spots.at(pp->locallab.selspot).thigw || thigw->getEditedState();
                        pe->locallab.spots.at(pp->locallab.selspot).edgw = pe->locallab.spots.at(pp->locallab.selspot).edgw || edgw->getEditedState();
                        pe->locallab.spots.at(pp->locallab.selspot).basew = pe->locallab.spots.at(pp->locallab.selspot).basew || basew->getEditedState();
                        pe->locallab.spots.at(pp->locallab.selspot).locedgwavcurve = pe->locallab.spots.at(pp->locallab.selspot).locedgwavcurve || !wavshapeedg->isUnChanged();
                        pe->locallab.spots.at(pp->locallab.selspot).localedgMethod = pe->locallab.spots.at(pp->locallab.selspot).localedgMethod || localedgMethod->get_active_text() != M("GENERAL_UNCHANGED");
                        pe->locallab.spots.at(pp->locallab.selspot).localneiMethod = pe->locallab.spots.at(pp->locallab.selspot).localneiMethod || localneiMethod->get_active_text() != M("GENERAL_UNCHANGED");
...
//                        pedited->locallab.spots.at(pp->locallab.selspot).mergeMethod = pedited->locallab.spots.at(pp->locallab.selspot).mergeMethod || se->mergeMethod;
                        ...
                        pedited->locallab.spots.at(pp->locallab.selspot).balanh = pedited->locallab.spots.at(pp->locallab.selspot).balanh || se->balanh;
                        pedited->locallab.spots.at(pp->locallab.selspot).colorde = pedited->locallab.spots.at(pp->locallab.selspot).colorde || se->colorde;
                        ...
                        pedited->locallab.spots.at(pp->locallab.selspot).strengthw = pedited->locallab.spots.at(pp->locallab.selspot).strengthw || strengthw->getEditedState();
                        pedited->locallab.spots.at(pp->locallab.selspot).radiusw = pedited->locallab.spots.at(pp->locallab.selspot).radiusw || radiusw->getEditedState();
                        pedited->locallab.spots.at(pp->locallab.selspot).detailw = pedited->locallab.spots.at(pp->locallab.selspot).detailw || detailw->getEditedState();
                        pedited->locallab.spots.at(pp->locallab.selspot).gradw = pedited->locallab.spots.at(pp->locallab.selspot).gradw || gradw->getEditedState();
                        pedited->locallab.spots.at(pp->locallab.selspot).tloww = pedited->locallab.spots.at(pp->locallab.selspot).tloww || tloww->getEditedState();
                        pedited->locallab.spots.at(pp->locallab.selspot).thigw = pedited->locallab.spots.at(pp->locallab.selspot).thigw || thigw->getEditedState();
                        pedited->locallab.spots.at(pp->locallab.selspot).edgw = pedited->locallab.spots.at(pp->locallab.selspot).edgw || edgw->getEditedState();
                        pedited->locallab.spots.at(pp->locallab.selspot).basew = pedited->locallab.spots.at(pp->locallab.selspot).basew || basew->getEditedState();
                        pedited->locallab.spots.at(pp->locallab.selspot).locedgwavcurve = pedited->locallab.spots.at(pp->locallab.selspot).locedgwavcurve || !wavshapeedg->isUnChanged();
...
void Locallab::curveChanged(CurveEditor* ce)
{
    ...
    if (getEnabled() && expcontrast->getEnabled()) {
        ...
        if (ce == wavshapeedg) {
            if (listener) {
                listener->panelChanged(EvlocallabwavCurveedg, M("HISTORY_CUSTOMCURVE"));
            }
        }
...
void Locallab::localedgMethodChanged()
{
    if (getEnabled() && expcontrast->getEnabled()) {
        if (listener) {
            listener->panelChanged(EvlocallablocaledgMethod, localedgMethod->get_active_text());
        }
    }
}

void Locallab::localneiMethodChanged()
{
    if (getEnabled() && expcontrast->getEnabled()) {
        if (listener) {
            listener->panelChanged(EvlocallablocalneiMethod, localneiMethod->get_active_text());
        }
    }
}
...
void Locallab::wavblurChanged()
{

    if (multiImage) {
        if (wavblur->get_inconsistent()) {
            wavblur->set_inconsistent(false);
            wavblurConn.block(true);
            wavblur->set_active(false);
    ...
    if (getEnabled() && expcontrast->getEnabled()) {
        if (listener) {
            if (wavblur->get_active()) {
                listener->panelChanged(Evlocallabwavblur, M("GENERAL_ENABLED"));
            } else {
                listener->panelChanged(Evlocallabwavblur, M("GENERAL_DISABLED"));
            }
        }
    }
}

void Locallab::wavedgChanged()
{
...
void Locallab::wavcontChanged()
{

    if (multiImage) {
        if (wavcont->get_inconsistent()) {
            wavcont->set_inconsistent(false);
            wavcontConn.block(true);
            wavcont->set_active(false);
    ...
    if (getEnabled() && expcontrast->getEnabled()) {
        if (listener) {
            if (wavcont->get_active()) {
                listener->panelChanged(Evlocallabwavcont, M("GENERAL_ENABLED"));
            } else {
                listener->panelChanged(Evlocallabwavcont, M("GENERAL_DISABLED"));
            }
        }
    }
}
...
void Locallab::origlcChanged()
{
    ...
    if (multiImage) {
        if (origlc->get_inconsistent()) {
            origlc->set_inconsistent(false);
            origlcConn.block(true);
            origlc->set_active(false);
    ...
    if (getEnabled() && expcontrast->getEnabled()) {
        if (listener) {
            if (origlc->get_active()) {
                listener->panelChanged(Evlocallaboriglc, M("GENERAL_ENABLED"));
            } else {
                listener->panelChanged(Evlocallaboriglc, M("GENERAL_DISABLED"));
            }
        }
    }
}
...
void Locallab::setDefaults(const rtengine::procparams::ProcParams * defParams, const ParamsEdited * pedited, int id)
{
    ...
    if (!pedited) {
        ...
        strengthw->setDefaultEditedState(Irrelevant);
        radiusw->setDefaultEditedState(Irrelevant);
        detailw->setDefaultEditedState(Irrelevant);
        gradw->setDefaultEditedState(Irrelevant);
        tloww->setDefaultEditedState(Irrelevant);
        thigw->setDefaultEditedState(Irrelevant);
        edgw->setDefaultEditedState(Irrelevant);
        basew->setDefaultEditedState(Irrelevant);
        ...
        strengthw->setDefaultEditedState(defSpotState->strengthw ? Edited : UnEdited);
        radiusw->setDefaultEditedState(defSpotState->radiusw ? Edited : UnEdited);
        detailw->setDefaultEditedState(defSpotState->detailw ? Edited : UnEdited);
        gradw->setDefaultEditedState(defSpotState->gradw ? Edited : UnEdited);
        tloww->setDefaultEditedState(defSpotState->tloww ? Edited : UnEdited);
        thigw->setDefaultEditedState(defSpotState->thigw ? Edited : UnEdited);
        edgw->setDefaultEditedState(defSpotState->edgw ? Edited : UnEdited);
        basew->setDefaultEditedState(defSpotState->basew ? Edited : UnEdited);
...
void Locallab::adjusterChanged(Adjuster * a, double newval)
{
    ...
    if (getEnabled() && expcontrast->getEnabled()) {
        ...
        if (a == offset) {
            if (listener) {
                listener->panelChanged(Evlocallaboffset, offset->getTextValue());
            }
        }
        ...
        if (a == strengthw) {
            if (listener) {
                listener->panelChanged(Evlocallabstrengthw, strengthw->getTextValue());
            }
        }

        if (a == radiusw) {
            if (listener) {
                listener->panelChanged(Evlocallabradiusw, radiusw->getTextValue());
            }
        }

        if (a == detailw) {
            if (listener) {
                listener->panelChanged(Evlocallabdetailw, detailw->getTextValue());
            }
        }

        if (a == gradw) {
            if (listener) {
                listener->panelChanged(Evlocallabgradw, gradw->getTextValue());
            }
        }

        if (a == tloww) {
            if (listener) {
                listener->panelChanged(Evlocallabtloww, tloww->getTextValue());
            }
        }

        if (a == thigw) {
            if (listener) {
                listener->panelChanged(Evlocallabthigw, thigw->getTextValue());
            }
        }

        if (a == edgw) {
            if (listener) {
                listener->panelChanged(Evlocallabedgw, edgw->getTextValue());
            }
        }

        if (a == basew) {
            if (listener) {
                listener->panelChanged(Evlocallabbasew, basew->getTextValue());
            }
        }
    ...
    if (getEnabled() && explog->getEnabled()) {
        ...
        if (a == baselog) {
            if (listener) {
                listener->panelChanged(Evlocallabbaselog, baselog->getTextValue());
            }
        }
...
void Locallab::setBatchMode(bool batchMode)
{
    ...
    strengthw->showEditedCB();
    radiusw->showEditedCB();
    detailw->showEditedCB();
    gradw->showEditedCB();
    tloww->showEditedCB();
    thigw->showEditedCB();
    edgw->showEditedCB();
    ...
    localedgMethod->append(M("GENERAL_UNCHANGED"));
    localneiMethod->append(M("GENERAL_UNCHANGED"));
...
//               se->mergeMethod = spotState->mergeMethod;
                ...
                se->balanh = spotState->balanh;
                se->colorde = spotState->colorde;
                ...
                strengthw->setEditedState(spotState->strengthw ? Edited : UnEdited);
                radiusw->setEditedState(spotState->radiusw ? Edited : UnEdited);
                detailw->setEditedState(spotState->detailw ? Edited : UnEdited);
                gradw->setEditedState(spotState->gradw ? Edited : UnEdited);
                tloww->setEditedState(spotState->tloww ? Edited : UnEdited);
                thigw->setEditedState(spotState->thigw ? Edited : UnEdited);
                edgw->setEditedState(spotState->edgw ? Edited : UnEdited);
                basew->setEditedState(spotState->basew ? Edited : UnEdited);
                wavshapeedg->setUnChanged(!spotState->locedgwavcurve);
                ...
                if (!spotState->localcontMethod) {
                    localcontMethod->set_active_text(M("GENERAL_UNCHANGED"));
                }
                if (!spotState->localedgMethod) {
                    localedgMethod->set_active_text(M("GENERAL_UNCHANGED"));
                }
                if (!spotState->localneiMethod) {
                    localneiMethod->set_active_text(M("GENERAL_UNCHANGED"));
                }
