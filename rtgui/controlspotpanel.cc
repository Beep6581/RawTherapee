...
ControlSpotPanel::ControlSpotPanel():
    ...
    colorde_(Gtk::manage(new Adjuster(M("TP_LOCALLAB_COLORDE"), -15, 15, 2, -5, Gtk::manage(new RTImage("circle-blue-small.png")),Gtk::manage(new RTImage("circle-green-small.png"))))),
