...
//    pack_start (*p2Frame, Gtk::PACK_EXPAND_WIDGET, 4);
    ...
    Gtk::Image* itempL1 =  Gtk::manage (new RTImage ("circle-blue.png"));
    Gtk::Image* itempR1 =  Gtk::manage (new RTImage ("circle-yellow.png"));
    Gtk::Image* igreenL1 = Gtk::manage (new RTImage ("circle-magenta.png"));
    Gtk::Image* igreenR1 = Gtk::manage (new RTImage ("circle-green.png"));
