    ...
    coloredBar(RTO_Left2Right)
{
    ...
    // TODO: This is a hack :) ; change this name to a specific one and create a new
    // entry in all CSS theme files
...
void SHCSelector::get_preferred_height_vfunc(
...
void SHCSelector::get_preferred_width_vfunc(
...
void SHCSelector::get_preferred_width_for_height_vfunc(
