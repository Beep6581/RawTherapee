...
MyCurve::MyCurve() :
    pipetteR(-1.f), pipetteG(-1.f), pipetteB(-1.f), pipetteVal(-1.f), listener(nullptr),
    cursor_type(CSArrow), graphX(0), graphY(0), graphW(0), graphH(0),
    mod_type(Gdk::MODIFIER_MASK), cursorX(0), cursorY(0), snapToMinDistX(0.0),
    snapToMinDistY(0.0), snapToValX(0.0), snapToValY(0.0)
{
...
void MyCurve::get_preferred_height_for_width_vfunc(
...
void MyCurve::get_preferred_width_for_height_vfunc(
...
void MyCurve::on_style_updated() { queue_draw(); }
