...
protected:
    ...
    void drawFrame(
        Cairo::RefPtr<Cairo::Context> cr, const Gdk::RGBA &bg, const Gdk::RGBA &fg);
...
public:
    ...
    virtual void drawProgressBar(Glib::RefPtr<Gdk::Window> win, const Gdk::RGBA &foregr,
        const Gdk::RGBA &backgr, int x, int w, int y, int h)
    {
    }
