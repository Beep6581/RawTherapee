...
class LensProfilePanel final : public ToolParamBlock, public FoldableToolPanel
{
public:
...
private:
    ...
    {
    public:
        class LFModelCam final : public Gtk::TreeModel::ColumnRecord
        {
        public:
            LFModelCam()
            {
        ...
        class LFModelLens final : public Gtk::TreeModel::ColumnRecord
        {
        public:
            LFModelLens()
            {
