...
/**
 * @brief subclass of Gtk::Label with extra fields for Combobox and Menu, to link with a
 * ProfileStoreEntry
 */
...
public:
     ...
     *
     * @param entry      Pointer to the ProfileStoreEntry object, be it a directory or a
     * file
     */
...
private:
    ...
    void refreshProfileList_(Gtk::TreeModel::Row *parentRow, int parentFolderId,
        bool initial, const std::vector<const ProfileStoreEntry *> *entryList);
    Gtk::TreeIter findRowFromEntry_(
    ...
    Gtk::TreeIter findRowFromFullPath_(Gtk::TreeModel::Children childs,
        int parentFolderId, const Glib::ustring &name) const;
