...
// GTK318
    ...
    set_border_width(
        5); // Space separating the parameters of a tool and its surrounding frame
#endif
    // GTK318
}
...
FoldableToolPanel::FoldableToolPanel(Gtk::Box *content, Glib::ustring toolName,
    Glib::ustring UILabel, bool need11, bool useEnabled) :
