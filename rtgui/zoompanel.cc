...
ZoomPanel::ZoomPanel(ImageArea *iarea) : iarea(iarea)
{
    ...
    Gtk::Image *image11 =
        Gtk::manage(new RTImage("magnifier-1to1", Gtk::ICON_SIZE_LARGE_TOOLBAR));
    image11->set_padding(0, 0);
    Gtk::Image *imageFit =
        Gtk::manage(new RTImage("magnifier-fit", Gtk::ICON_SIZE_LARGE_TOOLBAR));
    imageFit->set_padding(0, 0);
    Gtk::Image *imageFitCrop =
        Gtk::manage(new RTImage("magnifier-crop", Gtk::ICON_SIZE_LARGE_TOOLBAR));
    imageFit->set_padding(0, 0);
    ...
    setExpandAlignProperties(
        zoomFitCrop, false, false, Gtk::ALIGN_CENTER, Gtk::ALIGN_FILL);
    ...
    setExpandAlignProperties(
        zoomLabel, false, false, Gtk::ALIGN_CENTER, Gtk::ALIGN_FILL);
    attach_next_to(*zoomLabel, Gtk::POS_RIGHT, 1, 1);

    Gtk::Image *imageCrop =
        Gtk::manage(new RTImage("window-add", Gtk::ICON_SIZE_LARGE_TOOLBAR));
    ...
    zoomFitCrop->signal_clicked().connect(
        sigc::mem_fun(*this, &ZoomPanel::zoomFitCropClicked));
