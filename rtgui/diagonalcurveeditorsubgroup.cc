...
DiagonalCurveEditorSubGroup::DiagonalCurveEditorSubGroup(
    CurveEditorGroup *prt, Glib::ustring &curveDir) : CurveEditorSubGroup(curveDir)
{
    ...
    if (options.curvebboxpos == 0) {
        ...
        setExpandAlignProperties(
            custombbox, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_CENTER);
        ...
        setExpandAlignProperties(
            custombbox, false, true, Gtk::ALIGN_CENTER, Gtk::ALIGN_FILL);
    ...
    if (options.curvebboxpos == 0) {
        customCurveGrid->attach_next_to(
            *custombbox, *customCurveBox, Gtk::POS_TOP, 1, 1);
        customCurveGrid->attach_next_to(
            *customCoordAdjuster, *customCurveBox, Gtk::POS_BOTTOM, 1, 1);
    } else if (options.curvebboxpos == 1) {
        customCurveGrid->attach_next_to(
            *custombbox, *customCurveBox, Gtk::POS_RIGHT, 1, 1);
        customCurveGrid->attach_next_to(
            *customCoordAdjuster, *customCurveBox, Gtk::POS_BOTTOM, 2, 1);
    } else if (options.curvebboxpos == 2) {
        customCurveGrid->attach_next_to(
            *customCoordAdjuster, *customCurveBox, Gtk::POS_BOTTOM, 1, 1);
        customCurveGrid->attach_next_to(
            *custombbox, *customCoordAdjuster, Gtk::POS_BOTTOM, 1, 1);
    } else if (options.curvebboxpos == 3) {
        customCurveGrid->attach_next_to(
            *custombbox, *customCurveBox, Gtk::POS_LEFT, 1, 1);
        customCurveGrid->attach_next_to(
            *customCoordAdjuster, *custombbox, Gtk::POS_BOTTOM, 2, 1);
    }
    ...
    if (options.curvebboxpos == 0) {
        ...
        setExpandAlignProperties(
            NURBSbbox, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_CENTER);
        ...
        setExpandAlignProperties(
            NURBSbbox, false, true, Gtk::ALIGN_CENTER, Gtk::ALIGN_FILL);
    ...
    initButton(*editNURBS, Glib::ustring("crosshair-node-curve"), Gtk::ALIGN_START,
        false, "EDIT_PIPETTE_TOOLTIP");
    editNURBS->hide();
    ...
    if (options.curvebboxpos == 0) {
        ...
        NURBSCurveGrid->attach_next_to(
            *NURBSCoordAdjuster, *NURBSCurveBox, Gtk::POS_BOTTOM, 1, 1);
    } else if (options.curvebboxpos == 1) {
        NURBSCurveGrid->attach_next_to(
            *NURBSbbox, *NURBSCurveBox, Gtk::POS_RIGHT, 1, 1);
        NURBSCurveGrid->attach_next_to(
            *NURBSCoordAdjuster, *NURBSCurveBox, Gtk::POS_BOTTOM, 2, 1);
    } else if (options.curvebboxpos == 2) {
        NURBSCurveGrid->attach_next_to(
            *NURBSCoordAdjuster, *NURBSCurveBox, Gtk::POS_BOTTOM, 1, 1);
        NURBSCurveGrid->attach_next_to(
            *NURBSbbox, *NURBSCoordAdjuster, Gtk::POS_BOTTOM, 1, 1);
    } else if (options.curvebboxpos == 3) {
        NURBSCurveGrid->attach_next_to(*NURBSbbox, *NURBSCurveBox, Gtk::POS_LEFT, 1, 1);
        NURBSCurveGrid->attach_next_to(
            *NURBSCoordAdjuster, *NURBSbbox, Gtk::POS_BOTTOM, 2, 1);
    }
    ...
    if (options.curvebboxpos == 0) {
        ...
        setExpandAlignProperties(
            parambbox, true, false, Gtk::ALIGN_FILL, Gtk::ALIGN_CENTER);
        ...
        setExpandAlignProperties(
            parambbox, false, true, Gtk::ALIGN_CENTER, Gtk::ALIGN_FILL);
    ...
    initButton(*editParam, Glib::ustring("crosshair-node-curve"), Gtk::ALIGN_START,
        false, "EDIT_PIPETTE_TOOLTIP");
    editParam->hide();
    ...
    highlights =
        Gtk::manage(new Adjuster(M("CURVEEDITOR_HIGHLIGHTS"), -100, 100, 1, 0));
    ...
    // paramCurveSliderBox needed to set vspacing(4) between curve+shc and sliders
    // without vspacing between each slider
    ...
    if (options.curvebboxpos == 0) {
        ...
        paramCurveGrid->attach_next_to(
            *paramCurveSliderBox, *paramCurveBox, Gtk::POS_BOTTOM, 1, 1);
    } else if (options.curvebboxpos == 1) {
        paramCurveGrid->attach_next_to(
            *parambbox, *paramCurveBox, Gtk::POS_RIGHT, 1, 1);
        paramCurveGrid->attach_next_to(
            *paramCurveSliderBox, *paramCurveBox, Gtk::POS_BOTTOM, 2, 1);
    } else if (options.curvebboxpos == 2) {
        paramCurveGrid->attach_next_to(
            *parambbox, *paramCurveBox, Gtk::POS_BOTTOM, 1, 1);
        paramCurveGrid->attach_next_to(
            *paramCurveSliderBox, *parambbox, Gtk::POS_BOTTOM, 1, 1);
    } else if (options.curvebboxpos == 3) {
        paramCurveGrid->attach_next_to(*parambbox, *paramCurveBox, Gtk::POS_LEFT, 1, 1);
        paramCurveGrid->attach_next_to(
            *paramCurveSliderBox, *parambbox, Gtk::POS_BOTTOM, 2, 1);
    }
    ...
    evhighlights->signal_leave_notify_event().connect(sigc::bind(
        sigc::mem_fun(*this, &DiagonalCurveEditorSubGroup::adjusterLeft), 4));
    evlights->signal_leave_notify_event().connect(sigc::bind(
        sigc::mem_fun(*this, &DiagonalCurveEditorSubGroup::adjusterLeft), 5));
    evdarks->signal_leave_notify_event().connect(sigc::bind(
        sigc::mem_fun(*this, &DiagonalCurveEditorSubGroup::adjusterLeft), 6));
    evshadows->signal_leave_notify_event().connect(sigc::bind(
        sigc::mem_fun(*this, &DiagonalCurveEditorSubGroup::adjusterLeft), 7));
}
...
void DiagonalCurveEditorSubGroup::pipetteMouseOver(
    EditDataProvider *provider, int modifierKey)
{
...
bool DiagonalCurveEditorSubGroup::pipetteButton1Pressed(
    EditDataProvider *provider, int modifierKey)
{
    CurveEditor *curveEditor =
        static_cast<DiagonalCurveEditor *>(parent->displayedCurve);
...
void DiagonalCurveEditorSubGroup::pipetteDrag(
    EditDataProvider *provider, int modifierKey)
{
    CurveEditor *curveEditor =
        static_cast<DiagonalCurveEditor *>(parent->displayedCurve);
...
void DiagonalCurveEditorSubGroup::switchGUI()
{
    ...
    if (dCurve) {
        ...
        if (barColorProvider == nullptr && bgGradient.size() == 0) {
            ...
            // dCurve ave a ColorProvider or a background gradient defined, so we
            ...
            if (barColorProvider) {
                bgGradient.clear();
                leftBar->setColorProvider(
                    barColorProvider, dCurve->getLeftBarCallerId());
        ...
        if (barColorProvider == nullptr && bgGradient.size() == 0) {
            ...
            // dCurve has a ColorProvider or a background gradient defined, so we
            // create/update the object
            if (!bottomBar) {
            ...
            if (barColorProvider) {
                ...
                bottomBar->setColorProvider(
                    barColorProvider, dCurve->getBottomBarCallerId());
        ...
        switch (auto tp = (DiagonalCurveType)(dCurve->curveType->getSelected())) {
            ...
            case (DCT_CatumullRom):
                ...
                customCurve->setColorProvider(
                    dCurve->getCurveColorProvider(), dCurve->getCurveCallerId());
            ...
            case (DCT_Parametric): {
                ...
                double mileStone[3];
                dCurve->getRangeDefaultMilestones(
                ...
                shcSelector->setPositions(dCurve->paramCurveEd.at(1),
                    dCurve->paramCurveEd.at(2), dCurve->paramCurveEd.at(3));
                ...
                shcSelector->coloredBar.setColorProvider(
                    barColorProvider, dCurve->getBottomBarCallerId());
                shcSelector->coloredBar.setBgGradient(bgGradient);
                shcSelector->setMargins(
                    (int)((leftBar ? (double)CBAR_WIDTH + 2. + (double)CBAR_MARGIN +
                                         RADIUS
                                   : RADIUS) -
                          1.5),
                    (int)(RADIUS - 1.5));
...
void DiagonalCurveEditorSubGroup::editToggled(Gtk::ToggleButton *button)
{
    ...
    if (button->get_active()) {
        ...
        if (button != editCustom) {
            ...
            // will throw the event of curveChanged, which will now build the edit's
        buffer customCurve->notifyListener ();
        }
        if (button != editNURBS) {
        ...
        */
        ...
        dCurve->unsubscribe();
        /*
        if (button != editCustom ) { editCustomConn.block(true);
        editCustom->set_active(false);  editCustomConn.block(false); } if (button !=
        editNURBS  ) { editNURBSConn.block(true);   editNURBS->set_active(false);
        editNURBSConn.block(false);  } if (button != editParam  ) {
        editParamConn.block(true);   editParam->set_active(false);
        editParamConn.block(false);  }
        */
    }
}
...
/*
 * Store the curves of the currently displayed type from the widgets to the CurveEditor
 * object
 */
void DiagonalCurveEditorSubGroup::storeDisplayedCurve()
{
    if (parent->displayedCurve) {
        switch (parent->displayedCurve->selected) {
            ...
            case (DCT_Parametric):
                storeCurveValues(
                    parent->displayedCurve, getCurveFromGUI(DCT_Parametric));
                break;
            ...
            case (DCT_CatumullRom):
                storeCurveValues(
                    parent->displayedCurve, getCurveFromGUI(DCT_CatumullRom));
                break;
...
void DiagonalCurveEditorSubGroup::storeCurveValues(
    CurveEditor *ce, const std::vector<double> &p)
{
    if (!p.empty()) {
...
void DiagonalCurveEditorSubGroup::setSubGroupRangeLabels(
