...
DiagonalCurveEditorSubGroup::DiagonalCurveEditorSubGroup (CurveEditorGroup* prt, int slope) {
	...
	customCurve = Gtk::manage (new MyDiagonalCurve (slope));
	...
	NURBSCurve = Gtk::manage (new MyDiagonalCurve (slope));
	//Gtk::AspectFrame* af = Gtk::manage (new Gtk::AspectFrame ("",Gtk::ALIGN_CENTER,Gtk::ALIGN_CENTER,1,false));
	//af->add (*customCurve);
	...
	paramCurve = Gtk::manage (new MyDiagonalCurve (slope));
 ...
 */
DiagonalCurveEditor* DiagonalCurveEditorSubGroup::addCurve(Glib::ustring curveLabel, int slope) {
