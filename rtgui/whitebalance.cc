...
WhiteBalance::WhiteBalance () : FoldableToolPanel(this, TOOL_NAME, M("TP_WBALANCE_LABEL"), true, true), wbp(nullptr), wblistener(nullptr)
{
    ...
    EvWBObserver10 = m->newEvent(ALLNORAW | M_WB, "HISTORY_MSG_WBALANCE_OBSERVER10");
    EvWBitcwbprim = m->newEvent(ALLNORAW | M_WB, "HISTORY_MSG_WBITC_PRIM");
    EvWBitcwbalg = m->newEvent(ALLNORAW | M_WB, "HISTORY_MSG_WBITC_OBS");
    EvWBitcwgreen = m->newEvent(ALLNORAW | M_WB, "HISTORY_MSG_WBITC_GREEN");
