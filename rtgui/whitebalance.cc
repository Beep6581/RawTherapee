...
WhiteBalance::WhiteBalance () : FoldableToolPanel(this, TOOL_NAME, M("TP_WBALANCE_LABEL"), true, true), wbp(nullptr), wblistener(nullptr)
{
    ...
    itcwb_thres = Gtk::manage (new Adjuster(M("TP_WBALANCE_ITCWB_THRES"), 10, 65, 1, 34));
    ...
    itcwb_size = Gtk::manage (new Adjuster(M("TP_WBALANCE_ITCWB_SIZE"), 2, 6, 1, 3));
    ...
    itcwb_fgreen = Gtk::manage (new Adjuster(M("TP_WBALANCE_ITCWB_FGREEN"), 1, 6, 1, 2));
