...
void SplashImage::get_preferred_height_vfunc(
...
void SplashImage::get_preferred_width_vfunc(
...
void SplashImage::get_preferred_width_for_height_vfunc(
...
Splash::Splash(Gtk::Window &parent) : Gtk::Dialog(M("GENERAL_ABOUT"), parent, true)
{
    ...
    std::string releaseNotesFileName =
        Glib::build_filename(creditsPath, "RELEASE_NOTES.txt");
