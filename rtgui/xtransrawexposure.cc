    ...
    rtengine::procparams::ProcParams *pp, ParamsEdited *pedited)
{
    ...
    if (pedited) {
        ...
        pedited->raw.xtranssensor.exBlackGreen =
            PexBlackGreen->getEditedState();                                    // black
...
XTransRAWExposure::~XTransRAWExposure() { idle_register.destroy(); }

void XTransRAWExposure::autoBlackxChanged(
