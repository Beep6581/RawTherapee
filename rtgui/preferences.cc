...
/*
    ...
    spotlocal->append(M("PREFERENCES_SPOTLOC_NORM"));
    spotlocal->append(M("PREFERENCES_SPOLLOC_EXC"));
    spotlocal->append(M("PREFERENCES_SPOLLOC_FULL"));
    spotlocal->append(M("PREFERENCES_SPOTLOC_MAIN"));
