...
template<class T> void gaussianBlur(T** src, T** dst, const int W, const int H, const double sigma, T *buffer = NULL, eGaussType gausstype = GAUSS_STANDARD, T** buffer2 = NULL)
{
