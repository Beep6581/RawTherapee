...
//    procparams::DirPyrDenoiseParams dnparams;
    ...
    void sigmoid_main(float r, float g, float b, float &rout, float &gout, float &bout, float middle_grey_contrast, float contrast_skewness, float white_point, float MIDDLE_GREY);
