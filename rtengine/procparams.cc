...
int ProcParams::save (Glib::ustring fname) const {
    ...
    // save filter order
    keyFile.set_boolean ("Order of Filters", "Custom",   	filterOrder.custom);
    Glib::ArrayHandle<Glib::ustring> flist = filterOrder.filterlist;
    keyFile.set_string_list ("Order of Filters", "FilterList",  flist);

    // save demosaicing
    keyFile.set_string  ("Demosaicing", "Method",            	demosaicing.method);
    keyFile.set_integer ("Demosaicing", "ColorCorrectionSteps", demosaicing.colorcorrectionsteps);
...
if (keyFile.has_group ("Order of Filters")) {
    if (keyFile.has_key ("Order of Filters", "Custom"))  	filterOrder.custom  	= keyFile.get_boolean 	  ("Order of Filters", "Custom");
    if (keyFile.has_key ("Order of Filters", "FilterList")) filterOrder.filterlist 	= keyFile.get_string_list ("Order of Filters", "FilterList");
}

if (keyFile.has_group ("Demosaicing")) {
    if (keyFile.has_key ("Demosaicing", "Method")) 				 demosaicing.method 			  = keyFile.get_string  ("Demosaicing", "Method");
    if (keyFile.has_key ("Demosaicing", "ColorCorrectionSteps")) demosaicing.colorcorrectionsteps = keyFile.get_integer ("Demosaicing", "ColorCorrectionSteps");
}
