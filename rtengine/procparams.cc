...
void LocallabParams::getDefaultHHCurve (std::vector<double> &curve)
{
...
// save gradient
        ...
        if (!pedited || pedited->locallab.HHcurve)  {
            Glib::ArrayHandle<double> HHcurve = locallab.HHcurve;
            keyFile.set_double_list ("Locallab", "HHCurve", HHcurve);
        }
        ...
        if (!pedited || pedited->locallab.hueref) {
...
// load highlight recovery settings
        ...
        if (keyFile.has_group ("Locallab")) {
            ...
            if (keyFile.has_key ("Locallab", "HHCurve")) {
                locallab.HHcurve = keyFile.get_double_list ("Locallab", "HHCurve");

                if (pedited) {
                    pedited->locallab.HHcurve = true;
                }
            }
...
//AFT
            ...
            if (keyFile.has_key ("Locallab", "Hueref"))  {
                locallab.hueref  = keyFile.get_double ("Locallab", "Hueref");

                if (pedited) {
                    pedited->locallab.hueref = true;
                }
            }

            if (keyFile.has_key ("Locallab", "Chromaref"))  {
                locallab.chromaref  = keyFile.get_double ("Locallab", "Chromaref");

                if (pedited) {
                    pedited->locallab.chromaref = true;
                }
            }

            if (keyFile.has_key ("Locallab", "Lumaref"))  {
                locallab.lumaref  = keyFile.get_double ("Locallab", "Lumaref");
