...
const char *LensProfParams::methodstring[static_cast<size_t>(LensProfParams::eLcMode::lcp) + 1u] = {"none", "lfauto", "lfmanual", "lcp"};
        ...
        if (keyFile.has_group ("LensProfile")) {
            ...
            if (keyFile.has_key ("LensProfile", "LCPFile")) {
                ...
                if(ppVersion < 327 && !lensProf.lcpFile.empty()) {
                    lensProf.lcMode = LensProfParams::eLcMode::lcp;
                }
            }
