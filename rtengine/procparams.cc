...
const std::vector<WBEntry>& WBParams::getWbEntries()
{
    static const std::vector<WBEntry> wb_entries = {
        ...
        {"Fluo F13",             WBEntry::Type::FLUORESCENT, M("TP_WBALANCE_FLUO13"),      2700, 1.f,   1.f,   0.f},
        {"Fluo F14",             WBEntry::Type::FLUORESCENT, M("TP_WBALANCE_FLUO14"),      3200, 1.f,   1.f,   0.f},
        {"Fluo F15",             WBEntry::Type::FLUORESCENT, M("TP_WBALANCE_FLUO15"),      4000, 1.f,   1.f,   0.f},
        {"Fluo F16",             WBEntry::Type::FLUORESCENT, M("TP_WBALANCE_FLUO16"),      4200, 1.f,   1.f,   0.f},
        {"Fluo F17",             WBEntry::Type::FLUORESCENT, M("TP_WBALANCE_FLUO17"),      6200, 1.f,   1.f,   0.f},
        {"Fluo F18",             WBEntry::Type::FLUORESCENT, M("TP_WBALANCE_FLUO18"),      6500, 1.f,   1.f,   0.f},
        {"Fluo F19",             WBEntry::Type::FLUORESCENT, M("TP_WBALANCE_FLUO19"),      7400, 1.f,   1.f,   0.f},
        {"Fluo F20",             WBEntry::Type::FLUORESCENT, M("TP_WBALANCE_FLUO20"),      7500, 1.f,   1.f,   0.f},
	...
	{"NG Solux Lamp 4700K",  WBEntry::Type::LAMP,        M("TP_WBALANCE_SOLUX47_NG"),  4480, 1.f,   1.f,   0.f},
        {"Lisma DRV-160 4000К",  WBEntry::Type::LAMP,        M("TP_WBALANCE_LISMA40_DRV160"),     4000, 1.f,   1.f,   0.f},
        {"Thermal emitter lamp 150W 240V E27 T 240-150",  WBEntry::Type::LAMP,        M("TP_WBALANCE_THERMAL25_150"),     2500, 1.f,   1.f,   0.f},
	{"PHILIPS A55 60W E27 CL",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS60_A55"),     6000, 1.f,   1.f,   0.f},
	{"PHILIPS NR63 40W E27",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS60_NR63"),     6000, 1.f,   1.f,   0.f},
	{"PHILIPS A55 75W Е27 CL",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS60_A55_75W"),     6000, 1.f,   1.f,   0.f},
	{"PHILIPS NR50 40W E14",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS27_NR50"),     2700, 1.f,   1.f,   0.f},
	{"PHILIPS B35 60W Е14 CL",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS60_B35"),     6000, 1.f,   1.f,   0.f},
	{"PHILIPS B35 60W Е27 CL",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS35_B35_60W"),     3500, 1.f,   1.f,   0.f},
	{"PHILIPS P45 60W Е14 CL",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS60_P45_60W"),     6000, 1.f,   1.f,   0.f},
	{"BELZ DS60-3 60W E27",  WBEntry::Type::LAMP,        M("TP_WBALANCE_BELZ30_DS60-3_60W"),     3000, 1.f,   1.f,   0.f},
	{"LISMA B40 40W E27",  WBEntry::Type::LAMP,        M("TP_WBALANCE_LISMA35_B40_40W"),     3500, 1.f,   1.f,   0.f},
	{"PHILIPS NR63 60W E27",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS60_NR63_60W"),     6000, 1.f,   1.f,   0.f},
        {"ACCENT JCDR 230V 75W GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT28_JCDR"),    2800, 1.f,   1.f,   0.f},
        {"ACCENT JCDRC 230V 35W GU10",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT28_JCDRC"),    2800, 1.f,   1.f,   0.f},
        {"ACCENT JC 12V 20W G4",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT28_JC"),    2800, 1.f,   1.f,   0.f},
        {"KANLUX 2700K",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_KANLUX27"),    2700, 1.f,   1.f,   0.f},
        {"ACCENT MR16 12V 20W 36° GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT30_MR16"),    3000, 1.f,   1.f,   0.f},
        {"Kanlux J R7s 1000 W 2700K",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT27_J"),    2700, 1.f,   1.f,   0.f},
        {"ACCENT JC 12V 10W G4",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_KANLUX27_JC"),    2700, 1.f,   1.f,   0.f},
        {"Uniel ESL JC 20W G4 12V CL",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_UNICEL30_ESJ_JC"),    3000, 1.f,   1.f,   0.f},
        {"ACCENT MR16 12V 35W 36° GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT27_MR16"),    2700, 1.f,   1.f,   0.f},
        {"ACCENT MR16 12V 50W 36° GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT30_MR16"),    3000, 1.f,   1.f,   0.f},
        {"Uniel MR-16-35/GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_UNICEL30_MR"),    3000, 1.f,   1.f,   0.f},
        {"Uniel ESL JC 35W G4 12V CL",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_UNICEL30_ESJ_JC"),    3000, 1.f,   1.f,   0.f},
        {"ACCENT JCDR 230V 50W GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT28_JCDR"),    2800, 1.f,   1.f,   0.f},
        {"Uniel MR-16-50/GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_UNICEL30_MR"),    3000, 1.f,   1.f,   0.f},
        {"Uniel JCDR-50/GU10",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_UNICEL30_JCDR"),    3000, 1.f,   1.f,   0.f},
        {"Uniel JCDR-35/GU10",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_UNICEL30_JCDR"),    3000, 1.f,   1.f,   0.f},
        {"ACCENT JCDR 230V 35W GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT28_JCDR"),    2800, 1.f,   1.f,   0.f},
        {"Uniel JCDR-35/GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_UNICEL30_JCDR"),    3000, 1.f,   1.f,   0.f},
        {"Uniel JCD-CL-40/G9",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_UNICEL30_JCD"),    3000, 1.f,   1.f,   0.f},
        {"ACCENT JCDR 230V 35W GU5.3",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_ACCENT28_JCDR"),    2800, 1.f,   1.f,   0.f},
        {"Camelion MR16/JCDR 50W GX5.3 COOL 220V",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_CAMELION35_MR16_JCDR"),    3500, 1.f,   1.f,   0.f},
        {"35W GU4 420LM 12V",  WBEntry::Type::HALOGEN,        M("TP_WBALANCE_28_GU4"),    2700, 1.f,   1.f,   0.f},
	...
	{"OSRAM В60",  WBEntry::Type::LED,         M("TP_WBALANCE_OSRAM_B60"),     4000, 1.f,   1.f,   0.f},
	{"Philips В35 5W Е14 2700К Ecohome LED Candle",  WBEntry::Type::LED,         M("TP_WBALANCE_PHILIPS27_B35_5W"),     4000, 1.f,   1.f,   0.f},
	{"OSRAM Р60",  WBEntry::Type::LED,         M("TP_WBALANCE_OSRAM_P60"),     4000, 1.f,   1.f,   0.f},
	{"OSRAM A100 10W Е27 2700К LED STAR ClassicA",  WBEntry::Type::LED,         M("TP_WBALANCE_OSRAM_A100_10W"),     2700, 1.f,   1.f,   0.f},
        ...
        {"Flash 5600K",          WBEntry::Type::FLASH,      M("TP_WBALANCE_FLASH56"),      5600, 1.f,   1.f,   0.f},
        {"Glow of hot bodiesglow of hot bodies",          WBEntry::Type::GLOW,       M("TP_WBALANCE_GLOW"),     800, 1.f,   1.f,   0.f},
        {"Сandle 1",               WBEntry::Type::CANDLE,      M("TP_WBALANCE_CANDLE"),         1500, 1.f,   1.f,   0.f},
        {"Сandle 2",               WBEntry::Type::CANDLE,      M("TP_WBALANCE_CANDLE"),         2000, 1.f,   1.f,   0.f},
        {"Sodium lamp",               WBEntry::Type::SODIUM,      M("TP_WBALANCE_SODIUM"),         2000, 1.f,   1.f,   0.f},
        {"Incandescent lamp 40 W",               WBEntry::Type::INCANDESCENT,      M("TP_WBALANCE_INCANDESCENT40"),         2000, 1.f,   1.f,   0.f},
        {"Incandescent lamp 60 W",               WBEntry::Type::INCANDESCENT,      M("TP_WBALANCE_INCANDESCENT60"),         2680, 1.f,   1.f,   0.f},
        {"Incandescent lamp 100 W",               WBEntry::Type::INCANDESCENT,      M("TP_WBALANCE_INCANDESCENT100"),         2800, 1.f,   1.f,   0.f},
        {"Incandescent lamp 200 W",               WBEntry::Type::INCANDESCENT,      M("TP_WBALANCE_INCANDESCENT200"),         3000, 1.f,   1.f,   0.f},
        {"Gas-filled lamp 1",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS01"),         2800, 1.f,   1.f,   0.f},
        {"Gas-filled lamp 2",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS02"),         2854, 1.f,   1.f,   0.f},
        {"LISMA E40 230V/150W DNAT-150",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS150"),         2000, 1.f,   1.f,   0.f},
        {"LISMA E40 230V/100W DNAT-100",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS100"),         2000, 1.f,   1.f,   0.f},
        {"LISMA E40 230V/250W DNAT-250",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS250"),         2000, 1.f,   1.f,   0.f},
        {"LISMA IUSp 160W E27 220V 1",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS160"),         3000, 1.f,   1.f,   0.f},
        {"LISMA IUSp 160W E27 220V 2",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS160"),         3900, 1.f,   1.f,   0.f},
        {"LISMA IUSp 160W E27 220V 3",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS160"),         4000, 1.f,   1.f,   0.f},
        {"LISMA IUS 125W E27 220V 1",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS125"),         3500, 1.f,   1.f,   0.f},
        {"LISMA IUS 125W E27 220V 2",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS125"),         5000, 1.f,   1.f,   0.f},
        {"LISMA IUS 250W E40 220V",               WBEntry::Type::GAS,      M("TP_WBALANCE_GAS250"),         4000, 1.f,   1.f,   0.f},
        {"Film lamp 1",               WBEntry::Type::LAMP,      M("TP_WBALANCE_LAMP01"),         3200, 1.f,   1.f,   0.f},
        {"Film lamp 2",               WBEntry::Type::LAMP,      M("TP_WBALANCE_LAMP02"),         3250, 1.f,   1.f,   0.f},
        {"Sun",               WBEntry::Type::SUN,      M("TP_WBALANCE_SUN"),         3400, 1.f,   1.f,   0.f},
        {"Fluorescent Lamp 1",               WBEntry::Type::FLUORESCENT,      M("TP_WBALANCE_FLUORESCENT01"),         3500, 1.f,   1.f,   0.f},
        {"Fluorescent Lamp 2",               WBEntry::Type::FLUORESCENT,      M("TP_WBALANCE_FLUORESCENT02"),         7000, 1.f,   1.f,   0.f},
	{"OSRAM 23 11W 1U 4000К DULUX S 1U 11W/840 G23",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM40_G23_11W"),         4000, 1.f,   1.f,   0.f},
	{"OSRAM G13 18W L-590mm 6500К L 18W/865 LUMILUX",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM65_G13_18W"),         6500, 1.f,   1.f,   0.f},
	{"OSRAM G23 9W 4000K DULUX S 9W/840 G23",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM40_G23_9W"),         4000, 1.f,   1.f,   0.f},
	{"OSRAM 2G7 11W 4000К DULUX S/E 11W/840",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM40_2G7_11W"),        4000, 1.f,   1.f,   0.f},
	{"OSRAM G13 58W L-1500mm 4000К  58W/840 LUMILUX",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM40_G13_58W"),         4000, 1.f,   1.f,   0.f},
	{"OSRAM 2G7 9W 4000К DULUX S/E 9W/840",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM40_2G7_9W"),         4000, 1.f,   1.f,   0.f},
	{"OSRAM G13 18W L-590мм 3000К L 18W/830 LUMILUX",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM30_G13_18W"),         3000, 1.f,   1.f,   0.f},
	{"OSRAM Т5 14W 4000К L-550mm HE 14W/840 VS40",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM40_G13_14W"),         4000, 1.f,   1.f,   0.f},
	{"KAL-4U Е27 65W 6500К LLE10-27-065-6500",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_KAL40_4U_65W"),         6500, 1.f,   1.f,   0.f},
	{"LISMA G13 18W L-590mm 6500К Fl18/765",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_LISMA65_G13_18W"),         6500, 1.f,   1.f,   0.f},
	{"Philips MASTER TL-D Super 80 Т8 18W 3000К",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_PHILIPS30_TL-D_18W"),         3000, 1.f,   1.f,   0.f},
	{"Philips T5 28W G5 3000K L-1162 mm",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_PHILIPS30_T5_28W"),         3000, 1.f,   1.f,   0.f},
	{"Philips MASTER TL-D Super 80 Т8 18W 6500К",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_PHILIPS65_TL-D80_18W"),         6500, 1.f,   1.f,   0.f},
	{"Philips MASTER TL-D Super 80 Т8 18W 4000К",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_PHILIPS40_TL-D_18W"),         4000, 1.f,   1.f,   0.f},
	{"OSRAM Т5 35W 4000К L-1450mm 35W/840 VS40",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM40_T5_35W"),         4000, 1.f,   1.f,   0.f},
	{"OSRAM Т5 24W 4000К L-550mm 24W/840 VS40",               WBEntry::Type::LUMINESCENT,      M("TP_WBALANCE_OSRAM40_T5_24W"),         4000, 1.f,   1.f,   0.f},
        {"Lamp, used to highlight meat products in a store",               WBEntry::Type::LAMP,      M("TP_WBALANCE_LAMP"),         3800, 1.f,   1.f,   0.f},
        {"Cold white fluorescent lamp",               WBEntry::Type::FLUORESCENT,      M("TP_WBALANCE_FLUORESCENT"),         4000, 1.f,   1.f,   0.f},
        {"Morning sun 1",               WBEntry::Type::SUN,      M("TP_WBALANCE_SUN"),         4300, 1.f,   1.f,   0.f},
        {"Morning sun 2",               WBEntry::Type::SUN,      M("TP_WBALANCE_SUN"),         4500, 1.f,   1.f,   0.f},
        {"Xenon arc lamp 1",               WBEntry::Type::XENON,      M("TP_WBALANCE_XENON45"),         4500, 1.f,   1.f,   0.f},
        {"Xenon arc lamp 2",               WBEntry::Type::XENON,      M("TP_WBALANCE_XENON50"),         5000, 1.f,   1.f,   0.f},
        {"Sun at noon",               WBEntry::Type::SUN,      M("TP_WBALANCE_SUN"),         5000, 1.f,   1.f,   0.f},
        {"Clouds at noon",               WBEntry::Type::CLOUDY,      M("TP_WBALANCE_CLOUDY"),         5500, 1.f,   1.f,   0.f},
        {"Close to daylight",               WBEntry::Type::DAYLIGHT,      M("TP_WBALANCE_DAYLIGHT"),         6200, 1.f,   1.f,   0.f},
        {"Cloudy 1",               WBEntry::Type::CLOUDY,      M("TP_WBALANCE_CLOUDY01"),         6500, 1.f,   1.f,   0.f},
        {"Cloudy 2",               WBEntry::Type::CLOUDY,      M("TP_WBALANCE_CLOUDY02"),         7500, 1.f,   1.f,   0.f},
        {"Daylight",               WBEntry::Type::DAYLIGHT,      M("TP_WBALANCE_DAYLIGHT"),         7500, 1.f,   1.f,   0.f},
        {"Twilight 1",               WBEntry::Type::TWILIGHT,      M("TP_WBALANCE_TWILIGHT01"),         7500, 1.f,   1.f,   0.f},
        {"Twilight 2",               WBEntry::Type::TWILIGHT,      M("TP_WBALANCE_TWILIGHT02"),         8500, 1.f,   1.f,   0.f},
        {"Blue cloudless sky",               WBEntry::Type::SKY,      M("TP_WBALANCE_SKY"),         9500, 1.f,   1.f,   0.f},
        {"Light source with infinite temperature",               WBEntry::Type::LIGHT,      M("TP_WBALANCE_LIGHT"),         10000, 1.f,   1.f,   0.f},
        {"Clear blue sky",               WBEntry::Type::SKY,      M("TP_WBALANCE_SKY"),         15000, 1.f,   1.f,   0.f},
        {"Blue sky in polar latitudes",               WBEntry::Type::SKY,      M("TP_WBALANCE_SKY"),         20000, 1.f,   1.f,   0.f},
