...
const std::vector<WBEntry>& WBParams::getWbEntries()
{
	...
	{"PHILIPS NR63 60W E27",  WBEntry::Type::LAMP,        M("TP_WBALANCE_PHILIPS60_NR63_60W"),     6000, 1.f,   1.f,   0.f},
        ...
        {"Fluorescent Lamp 1",               WBEntry::Type::FLUORESCENT,      M("TP_WBALANCE_FLUORESCENT"),         3500, 1.f,   1.f,   0.f},
        {"Fluorescent Lamp 2",               WBEntry::Type::FLUORESCENT,      M("TP_WBALANCE_FLUORESCENT"),         7000, 1.f,   1.f,   0.f},
