...
int refreshmap[rtengine::NUMOFEVENTS] = {
    ...
    LUMINANCECURVE,   // Evlocallabthrbl
    LUMINANCECURVE,   //EvlocallabwavCurveguid
    LUMINANCECURVE,   // Evlocallablevelbl
    LUMINANCECURVE,   // Evlocallabsigbl
    LUMINANCECURVE,   //EvlocallabquaMethod
    LUMINANCECURVE,   //EvlocallabwavCurvehue
    LUMINANCECURVE,   //Evlocallablevelsigm
    LUMINANCECURVE,   //Evlocallablevelthr
    LUMINANCECURVE,   //Evlocallablimden
    LUMINANCECURVE   //Evlocallabusemask
};
