...
public:
    ...
    virtual void WBChanged(double temp, double green, double rw, double gw, double bw, int dread, float studgood, float minchrom, int kmin, float histmin, float histmax) = 0;
};
