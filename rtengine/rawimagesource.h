...
protected:
    ...
    void amaze_demosaic_RT(int winx, int winy, int winw, int winh, const array2D<float> &rawData, array2D<float> &red, array2D<float> &green, array2D<float> &blue, const int ex, const int ey);//Emil's code for AMaZE
