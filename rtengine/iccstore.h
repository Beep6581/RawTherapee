...
class ICCStore {
        ...
        std::map<String, cmsHPROFILE> wProfiles;
        std::map<String, cmsHPROFILE> wProfilesGamma;
        std::map<String, Matrix33> wMatrices;
        std::map<String, Matrix33> iwMatrices;
        
        std::map<String, cmsHPROFILE>    fileProfiles;
        std::map<String, ProfileContent> fileProfileContents;
    ...
    public:
        ...
        StringList getWorkingProfiles ();			/// returns the vector of names of the working profiles available
        ...
        StringList 		parseDir     (const String& pdir);		/// parse the given directory and load all icc files found
        StringList		getOutputProfiles ();					/// returns the list of names of all icc profiles loaded
