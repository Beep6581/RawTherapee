...
class Image8 : public ImageIO, public IImage8 {
    ...
    public:
       ...
       ~Image8 ();
        ...
        virtual int saveToFile (const String& fname) { return save (fname); }
        virtual int saveAsPNG  (const String& fname, int compression = -1, int bps = -1) { return savePNG (fname, compression, bps); }
        virtual int saveAsJPEG (const String& fname, int quality = 100) { return saveJPEG (fname, quality); }
        virtual int saveAsTIFF (const String& fname, int bps = -1, bool uncompressed = false) { return saveTIFF (fname, bps, uncompressed); }
