...
//    EvPixelShiftMedian3 = 469,
    ...
    Evlocallabblendmaskcie = 1126,
    Evlocallabradmaskcie = 1127,
    Evlocallabchromaskcie = 1128,
    EvlocallabLmaskcieshape = 1129,
    Evlocallabrecothrescie = 1130,
    ...
    Evlocallabqtoj = 1137,
    Evlocallabsaturjzcie = 1138,
    EvLocallabSpotdenoichmask = 1139,
    Evlocallabsigmalcjz = 1140,
    EvlocallabcsThresholdjz = 1141,
    EvlocallabwavCurvejz = 1142,
    Evlocallabclarilresjz = 1143,
    Evlocallabclaricresjz = 1144,
    Evlocallabclarisoftjz = 1145,
    NUMOFEVENTS
};
