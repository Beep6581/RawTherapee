...
//    EvPixelShiftMedian3 = 469,
    ...
    EvlocallabCHshapejz = 1099,
    Evlocallabjz100 = 1100,
    Evlocallabpqremap = 1101,
    EvlocallabLHshapejz = 1102,
    Evlocallabshargam = 1103,
    Evlocallabvibgam = 1104,
    EvLocallabtoneMethodcie = 1105,
    Evlocallabshapecie = 1106,
    EvLocallabtoneMethodcie2 = 1107,
    Evlocallabshapecie2 = 1108,
    Evlocallabshapejz = 1109,
    ...
    Evlocallabpqremapcam16 = 1113,
    EvLocallabEnacieMask = 1114,
    EvlocallabCCmaskcieshape = 1115,
    EvlocallabLLmaskcieshape = 1116,
    EvlocallabHHmaskcieshape = 1117,
    Evlocallabblendmaskcie = 1118,
    Evlocallabradmaskcie = 1119,
    Evlocallabchromaskcie = 1120,
    EvlocallabLmaskcieshape = 1121,
    Evlocallabrecothrescie = 1122,
    Evlocallablowthrescie = 1123,
    Evlocallabhigthrescie = 1124,
    Evlocallabdecaycie = 1125,
    Evlocallablapmaskcie = 1126,
    Evlocallabgammaskcie = 1127,
    Evlocallabslomaskcie = 1128,
    Evlocallabqtoj = 1129,
    Evlocallabsaturjzcie = 1130,
    EvLocallabSpotdenoichmask = 1131,
    Evlocallabsigmalcjz = 1132,
    EvlocallabcsThresholdjz = 1133,
    EvlocallabwavCurvejz = 1134,
    Evlocallabclarilresjz = 1135,
    Evlocallabclaricresjz = 1136,
    Evlocallabclarisoftjz = 1137,
    NUMOFEVENTS
};
